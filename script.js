...
const TRANSLATIONS = {
  ...
  de: {
    ...
    guide_dashboard_tip:'Mach das Dashboard-Checken zu einer Gewohnheit - schon 10 Sekunden am Tag verhindern, dass aus kleinen Überraschungen große werden.',
    ...
    guide_transactions_tip:'Trage Transaktionen noch am selben Tag ein. Es dauert nur Sekunden und hält dein Dashboard zuverlässig.',
    ...
    guide_income_tip:'Erfasse jede Einnahmequelle einzeln, auch kleine oder unregelmäßige - so erkennst du Muster über die Zeit viel leichter.',
    ...
    guide_expenses_tip:'Starte mit nur einer Handvoll grober Kategorien. Du kannst sie später jederzeit weiter aufteilen, sobald du siehst, wohin das Geld wirklich fließt.',
    ...
    guide_bills_tip:'Trage wiederkehrende Rechnungen gleich zu Beginn jeder Periode ein, damit die Fälligkeitsdaten auf dich warten, statt dass du sie dir merken musst.',
    ...
    guide_debt_connect2:'Diese Seite verfolgt Zahlungen als Kategorie, nicht als vollständigen Tilgungsplan - wenn du eine Schneeball- oder Lawinenstrategie mit Zinsprognosen möchtest, ist dafür der Schuldentilgungsrechner von Ultimate Budget Planner gemacht.',
    ...
    guide_debt_tip:'Liste auch kleine Schulden auf, etwa ein Familiendarlehen - es geht nicht um die Höhe, sondern darum, alles, was du schuldest, an einem Ort zu wissen.',
    ...
    guide_savings_tip:'Lege deinen Sparbetrag zuerst fest, bevor du den Rest deines Budgets planst - es ist viel leichter, ein Ziel zu erreichen, zu dem du dich von vornherein verpflichtest.',
  ...
  fr: {
    ...
    guide_dashboard_tip:"Prenez l'habitude de consulter le tableau de bord - même 10 secondes par jour évitent que de petites surprises n'en deviennent de grosses.",
    guide_transactions_title:'Transactions',
    ...
    guide_transactions_tip:"Saisissez les transactions le jour même. Cela prend quelques secondes et garde votre tableau de bord fiable.",
    ...
    guide_income_tip:"Ajoutez chaque source de revenu séparément, même petite ou irrégulière - cela permet de repérer des tendances bien plus facilement avec le temps.",
    ...
    guide_expenses_tip:"Commencez avec seulement quelques grandes catégories. Vous pourrez toujours les détailler davantage une fois que vous verrez où part vraiment l'argent.",
    ...
    guide_bills_tip:"Ajoutez vos factures récurrentes en début de période pour que les échéances vous attendent, au lieu d'avoir à vous en souvenir.",
    ...
    guide_debt_connect2:"Cette page suit les paiements comme une catégorie, pas comme un plan de remboursement complet - pour une stratégie boule de neige ou avalanche avec projections d'intérêts, c'est à ça que sert le Calculateur de remboursement de dette d'Ultimate Budget Planner.",
    ...
    guide_savings_tip:"Fixez votre montant d'épargne en premier, avant de planifier le reste de vos dépenses - il est bien plus facile d'atteindre un objectif auquel vous vous engagez dès le départ.",
  ...
  es: {
    ...
    guide_dashboard_tip:'Haz que revisar el Panel sea parte de tu rutina - incluso 10 segundos al día evitan que pequeñas sorpresas se conviertan en grandes.',
    ...
    guide_transactions_tip:'Registra las transacciones el mismo día que ocurren. Toma solo segundos y mantiene tu Panel confiable.',
    ...
    guide_income_tip:'Agrega cada fuente de ingreso por separado, incluso las pequeñas o irregulares - así detectas patrones mucho más fácilmente con el tiempo.',
    ...
    guide_expenses_tip:'Empieza con solo un puñado de categorías amplias. Siempre puedes dividirlas más adelante en cuanto veas hacia dónde va realmente el dinero.',
    ...
    guide_bills_tip:'Registra las facturas recurrentes al inicio de cada período para que los vencimientos te esperen a ti, en lugar de tener que recordarlos.',
    ...
    guide_debt_connect2:'Esta página sigue los pagos como una categoría, no como un plan de pago completo - si quieres una estrategia de bola de nieve o avalancha con proyecciones de interés, para eso está la Calculadora de pago de deudas de Ultimate Budget Planner.',
    ...
    guide_debt_tip:'Enumera incluso las deudas pequeñas, como un préstamo familiar - lo importante no es el monto, sino saber todo lo que debes en un solo lugar.',
    ...
    guide_savings_tip:'Fija tu importe de ahorro primero, antes de planear el resto de tu gasto - es mucho más fácil alcanzar una meta con la que te comprometes desde el principio.',
  ...
  it: {
    ...
    guide_dashboard_tip:"Rendi il controllo della Dashboard parte della tua routine - anche solo 10 secondi al giorno evitano che piccole sorprese diventino grandi.",
    ...
    guide_transactions_tip:"Registra le transazioni lo stesso giorno in cui avvengono. Richiede pochi secondi e mantiene affidabile la tua Dashboard.",
    ...
    guide_income_tip:"Aggiungi ogni fonte di entrata separatamente, anche quelle piccole o irregolari - così è molto più facile individuare gli schemi nel tempo.",
    ...
    guide_expenses_tip:"Inizia con solo una manciata di categorie ampie. Potrai sempre suddividerle meglio più avanti, una volta capito dove vanno davvero i soldi.",
    ...
    guide_bills_tip:"Registra le bollette ricorrenti a inizio periodo così le scadenze ti aspettano, invece di doverle ricordare.",
    ...
    guide_debt_connect2:"Questa pagina traccia i pagamenti come una categoria, non come un piano di rimborso completo - se vuoi una strategia a valanga o a palla di neve con proiezioni sugli interessi, è a questo che serve il Calcolatore di rimborso debiti di Ultimate Budget Planner.",
    ...
    guide_savings_tip:"Fissa prima l'importo del risparmio, prima di pianificare il resto delle spese - è molto più facile raggiungere un obiettivo a cui ti impegni fin dall'inizio.",
  ...
  pl: {
    ...
    guide_dashboard_tip:'Zrób z sprawdzania Pulpitu część swojej rutyny - nawet 10 sekund dziennie zapobiega temu, by małe niespodzianki stały się dużymi.',
    ...
    guide_transactions_tip:'Zapisuj transakcje tego samego dnia, w którym mają miejsce. Zajmuje to tylko kilka sekund i sprawia, że twój Pulpit pozostaje wiarygodny.',
    ...
    guide_income_tip:'Dodawaj każde źródło przychodu osobno, nawet te małe lub nieregularne - dzięki temu znacznie łatwiej zauważyć wzorce z czasem.',
    ...
    guide_expenses_tip:'Zacznij od kilku szerokich kategorii. Zawsze możesz je później podzielić bardziej szczegółowo, gdy zobaczysz, gdzie naprawdę idą pieniądze.',
    ...
    guide_bills_tip:'Dodawaj cykliczne rachunki na początku każdego okresu, aby terminy na ciebie czekały, zamiast że musisz je pamiętać.',
    ...
    guide_debt_connect2:'Ta strona śledzi płatności jako kategorię, a nie pełny plan spłaty - jeśli chcesz strategię kuli śnieżnej lub lawiny z prognozami odsetek, właśnie do tego służy Kalkulator spłaty długów w Ultimate Budget Planner.',
    ...
    guide_savings_tip:'Ustaw najpierw kwotę oszczędności, zanim zaplanujesz resztę wydatków - dużo łatwiej jest osiągnąć cel, do którego zobowiązujesz się od samego początku.',
