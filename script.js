...
const TRANSLATIONS = {
  en: {
    ...
    guide_settings_step4:'Pick an <strong>Appearance</strong> theme (Light, Dark, Synthwave, Vintage, or Terminal), and choose your <strong>Language</strong> from the list.',
