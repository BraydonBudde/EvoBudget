...
const NAV_WIDGET_PAYABLE = new Set(['bills', 'debt']);
...
function wireNavWidgets(host) {
  ...
  host.querySelectorAll('[data-nw-pay]').forEach(b => b.addEventListener('click', () =>
    promptMarkModulePaid(b.dataset.nwPaytype, b.dataset.nwPay, () => {
      if (currentBTab === 'dashboard') renderDashboard();
      renderNavWidgets();
    })));
