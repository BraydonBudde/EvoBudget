...
const TRANSLATIONS = {
  en: {
    ...
    sett_penny_desc:'Ask Penny questions about your budget, spending, debts and savings \u2014 answered using your real numbers, right in the app.',
    ...
    penny_disclaimer:'Penny is AI and may make mistakes. Always double-check important numbers.',
    ...
    help_penny_safety_p:"Your key is encrypted before it's saved in your browser's own storage, and it's only ever sent directly to Google's API when you ask Penny a question \u2014 never to any Evo Budget server.",
  ...
  de: {
    ...
    sett_penny_desc:'Stelle Penny Fragen zu deinem Budget, deinen Ausgaben, Schulden und Ersparnissen — beantwortet mit deinen echten Zahlen, direkt in der App.',
    ...
    penny_disclaimer:'Penny ist eine KI und kann Fehler machen. Überprüfe wichtige Zahlen immer selbst.',
    ...
    help_penny_safety_p:'Dein Schlüssel wird verschlüsselt, bevor er im Speicher deines eigenen Browsers gespeichert wird, und wird nur direkt an die API von Google gesendet, wenn du Penny eine Frage stellst — niemals an einen Server von Evo Budget.',
  ...
  fr: {
    ...
    sett_penny_desc:'Posez des questions à Penny sur votre budget, vos dépenses, vos dettes et votre épargne — des réponses basées sur vos vrais chiffres, directement dans l’application.',
    ...
    penny_disclaimer:'Penny est une IA et peut se tromper. Vérifiez toujours les chiffres importants.',
    ...
    help_penny_safety_p:'Votre clé est chiffrée avant d’être enregistrée dans le stockage de votre propre navigateur, et elle n’est envoyée directement à l’API de Google que lorsque vous posez une question à Penny — jamais à un serveur d’Evo Budget.',
  ...
  es: {
    ...
    sett_penny_desc:'Pregúntale a Penny sobre tu presupuesto, gastos, deudas y ahorros — respuestas basadas en tus cifras reales, directamente en la app.',
    ...
    penny_disclaimer:'Penny es una IA y puede cometer errores. Verifica siempre las cifras importantes.',
    ...
    help_penny_safety_p:'Tu clave se cifra antes de guardarse en el almacenamiento de tu propio navegador, y solo se envía directamente a la API de Google cuando le haces una pregunta a Penny — nunca a un servidor de Evo Budget.',
  ...
  it: {
    ...
    sett_penny_desc:'Chiedi a Penny informazioni sul tuo budget, spese, debiti e risparmi — risposte basate sui tuoi dati reali, direttamente nell’app.',
    ...
    penny_disclaimer:'Penny è un’IA e può commettere errori. Verifica sempre i dati importanti.',
    ...
    help_penny_safety_p:'La tua chiave viene crittografata prima di essere salvata nell’archivio del tuo browser, e viene inviata direttamente all’API di Google solo quando fai una domanda a Penny — mai a un server di Evo Budget.',
  ...
  pl: {
    ...
    sett_penny_desc:'Zadawaj Penny pytania o swój budżet, wydatki, długi i oszczędności — odpowiedzi na podstawie Twoich prawdziwych danych, prosto w aplikacji.',
    ...
    penny_disclaimer:'Penny jest AI i może popełniać błędy. Zawsze sprawdzaj ważne liczby samodzielnie.',
    ...
    help_penny_safety_p:'Twój klucz jest szyfrowany przed zapisaniem w pamięci Twojej przeglądarki i jest wysyłany bezpośrednio do API Google tylko wtedy, gdy zadajesz Penny pytanie — nigdy do żadnego serwera Evo Budget.',
