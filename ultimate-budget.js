...
const TRANSLATIONS = {
  en: {
    ...
    guide_settings_step3:'Pick an <strong>Appearance</strong> theme (Light, Dark, Synthwave, Vintage, or Terminal), and choose your <strong>Language</strong> from the list.',
  ...
  de: {
    ...
    guide_penny_tip:'Starte beim ersten Mal mit einer der Schnellfragen-Schaltflächen - so siehst du am schnellsten, was sie kann, bevor du eigene Fragen stellst.',guide_penny_usecase_h:'So sieht das in der Praxis aus',guide_penny_usecase_p:'<p>Immer wenn <strong>Diane</strong> nicht sicher ist, wofür sie diesen Monat Geld ausgegeben hat, öffnet sie Penny und fragt: "Warum sind meine Ausgaben diesen Monat höher als sonst?"</p><p>Penny schaut sich ihre tatsächlichen Transaktionen an und gibt ihr eine verständliche Antwort - zum Beispiel, dass sich die Ausgaben fürs Essengehen verdoppelt haben - statt dass sie selbst die Transaktionsliste durchsuchen muss.</p>',
  ...
  fr: {
    ...
    guide_dashboard_tip:"Prenez 30 secondes chaque matin pour parcourir le tableau de bord - c'est le moyen le plus rapide de repérer une facture ou un paiement de dette avant qu'il ne soit en retard.",guide_dashboard_usecase_h:'Un exemple concret',guide_dashboard_usecase_p:"<p><strong>Maria</strong> ouvre Evo Budget le jour de paie. Elle jette un œil au tableau de bord et voit que son solde net pour cette période est de 420 € - assez pour ajouter un peu plus à son fonds d'urgence.</p><p>Le panneau de flux de trésorerie montre qu'elle dépasse déjà son budget Restaurants, alors elle renonce à commander à emporter ce soir-là au lieu de le découvrir à la fin du mois.</p>",
    guide_transactions_title:'Transactions',
    ...
    guide_sinking_tip:"Découpez les grands objectifs en montants mensuels ronds - il est bien plus facile de s'engager à 50 € par mois que de « économiser pour des vacances un jour ».",guide_sinking_usecase_h:'Un exemple concret',guide_sinking_usecase_p:"<p><strong>Elena</strong> prépare des vacances à 1 200 € pour juillet prochain. Elle crée une Réserve avec ce montant cible et cette date, et Evo Budget lui indique qu'elle doit épargner 150 €/mois pour y arriver.</p><p>Elle active <strong>Automatiser</strong> pour que ce montant soit enregistré comme contribution chaque mois sans qu'elle ait besoin d'y penser.</p>",
  ...
  es: {
    ...
    guide_automation_tip:'Activa la Automatización una vez que tus reglas recurrentes te parezcan correctas - es más útil cuando confías en los números que va a registrar.',guide_automation_usecase_h:'Así se usa en la práctica',guide_automation_usecase_p:'<p><strong>Tom</strong> tiene tres cosas que se repiten cada mes: el alquiler, la cuota de su préstamo de coche y una suscripción a Netflix. En lugar de escribir las tres a mano cada período, activa <strong>Automatizar</strong> en cada una.</p><p>Cada vez que abre la app en un nuevo período, Evo Budget ya las ha registrado como transacciones según lo previsto, y Tom solo necesita revisar lo nuevo en lugar de volver a introducir lo rutinario.</p>',
    guide_penny_title:'Penny',
  ...
  it: {
    ...
    guide_penny_tip:"Inizia con uno dei pulsanti di domanda rapida la prima volta - è il modo più veloce per vedere cosa sa fare prima di fare domande tue.",guide_penny_usecase_h:'Un esempio pratico',guide_penny_usecase_p:'<p>Ogni volta che <strong>Diane</strong> non è sicura di dove sia finito il suo denaro questo mese, apre Penny e chiede "perché le mie spese sono più alte del solito questo mese?"</p><p>Penny esamina le sue transazioni reali e le dà una risposta in linguaggio semplice - segnalando, ad esempio, che la spesa per i Ristoranti è raddoppiata - invece di doversi mettere a scavare da sola nell\'elenco delle transazioni.</p>',
  ...
  pl: {
    ...
    guide_dashboard_tip:'Poświęć 30 sekund każdego ranka na przejrzenie Pulpitu - to najszybszy sposób, by zauważyć rachunek lub płatność długu, zanim się spóźni.',guide_dashboard_usecase_h:'Zobacz to w praktyce',guide_dashboard_usecase_p:'<p><strong>Maria</strong> otwiera Evo Budget w dniu wypłaty. Rzuca okiem na Pulpit i widzi, że jej saldo netto za ten okres wynosi 420 zł - wystarczająco, by dołożyć trochę więcej do funduszu awaryjnego.</p><p>Panel przepływu środków pokazuje, że przekroczyła już budżet na Restauracje, więc tego wieczoru rezygnuje z zamawiania jedzenia na wynos, zamiast dowiedzieć się o tym dopiero na koniec miesiąca.</p>',
    ...
    guide_penny_tip:'Zacznij od jednego z przycisków szybkich pytań za pierwszym razem - to najszybszy sposób, by zobaczyć, co potrafi, zanim zadasz własne pytania.',guide_penny_usecase_h:'Zobacz to w praktyce',guide_penny_usecase_p:'<p>Ilekroć <strong>Diane</strong> nie jest pewna, na co poszły jej pieniądze w tym miesiącu, otwiera Penny i pyta: "dlaczego moje wydatki są wyższe niż zwykle w tym miesiącu?"</p><p>Penny analizuje jej rzeczywiste transakcje i udziela odpowiedzi w prostym języku - wskazując na przykład, że wydatki na Restauracje się podwoiły - zamiast konieczności samodzielnego przeszukiwania listy transakcji.</p>',
