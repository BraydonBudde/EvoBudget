...
'use strict';
/* =====================================================================
   Evio Budget - Ultimate Budget Planner  (ultimate-budget.js)
   ===================================================================== */
...
const TRANSLATIONS = {
  en: {
    ...
    // Evio (AI assistant)
    sett_penny_h:'Evio (AI Budget Assistant)',
    sett_penny_desc:'Ask Evio questions about your budget & spending habits',
    ...
    sett_penny_available:'Evio is now available in the navigation menu.',
    ...
    penny_nav_pill_off:'Enable Evio',
    penny_nav_pill_on:'Ask Evio',
    penny_nav_aria_off:'Enable Evio',
    penny_nav_aria_on:'Ask Evio',
    penny_chat_title:'Ask Evio',
    penny_input_placeholder:'Ask about your budget\u2026',
    penny_send:'Ask',
    penny_thinking:'Evio is thinking\u2026',
    ...
    penny_err_blocked:"Evio couldn't come up with a safe answer to that. Try rephrasing your question about your budget.",
    ...
    help_sett_penny_p:'Turn on Evio below to ask questions about your budget in plain English. Tap "How to create my key" for setup steps.',
    help_penny_title:'Setting up Evio',
    help_penny_intro:"Evio is Evio Budget's AI assistant. Since this app has no server of its own, Evio talks directly from your browser to Google using your own free Gemini API key. Nothing ever passes through an Evio Budget server, because there isn't one.",
    ...
    help_penny_step4:'Paste it into the "Gemini API Key" field in Evio Budget\u2019s Settings and click "Save key".',
    ...
    help_penny_safety_p:"Your key is encrypted before it's saved in your browser's own storage, and it's only ever sent directly to Google's API when you ask Evio a question. It never goes to any Evio Budget server.",
    ...
    guide_dashboard_tip:"Set aside 30 seconds each morning to scan the Dashboard - it's the fastest way to catch a bill or debt payment before it's overdue.",guide_dashboard_usecase_h:'See it in action',guide_dashboard_usecase_p:"<p><strong>Maria</strong> opens Evio Budget on payday. She glances at the Dashboard and sees her Net Leftover this period is $420 - enough to add a bit extra to her emergency fund.</p><p>The Cash Flow panel shows she's already over budget on Dining, so she skips ordering takeout that night instead of finding out at the end of the month.</p>",
    ...
    guide_penny_connect1:'Evio can only see your budget data to answer questions - she can never add, edit, or delete anything for you.',
    ...
    guide_penny_connect3:"Your API key is encrypted and stored only on your own device - it's never sent anywhere except directly to Google when you ask Evio a question.",
    guide_penny_tip:"Start with one of the quick-question buttons the first time - it's the fastest way to see what she can do before asking your own questions.",guide_penny_usecase_h:'See it in action',guide_penny_usecase_p:'<p>Whenever <strong>Diane</strong> isn\'t sure where her money went this month, she opens Evio and asks "why is my spending higher than usual this month?"</p><p>Evio looks at her actual transactions and gives her a plain-language answer - pointing out, say, that Dining spending doubled - instead of her having to dig through the Transactions list herself.</p>',
  ...
  de: {
    ...
    help_sf_reading_p:'Jede Karte zeigt gespartes Geld vs. Ziel, einen Fortschrittsbalken und genau, wie viel du monatlich sparen musst, um rechtzeitig dein Ziel zu erreichen. Bei 100 % erscheint auf der Karte das Abzeichen „Ziel erreicht".',
    ...
    help_tx_edit_p:'Klicke \u270F\uFE0F auf eine Transaktion zum Bearbeiten, oder \u00d7 zum Löschen. Um alles zu löschen, nutze „Alle löschen".',help_tx_bulk_h:'Mehrere Transaktionen auswählen',help_tx_bulk_p:'Aktiviere das Kästchen neben einer Transaktion, um sie auszuwählen, oder nutze das Kästchen in der Kopfzeile, um die ganze Seite auszuwählen. Wenn deine Suche oder dein Filter mehr als eine Seite ergibt, kannst du mit „Alle übereinstimmenden auswählen" alle Treffer auf einmal erfassen und dann gemeinsam löschen.',help_tx_auto_h:'Automatische Transaktionen',help_tx_auto_p:'Erstelle eine Regel für alles, was sich wiederholt (z.B. Miete oder Gehalt) und wähle die Häufigkeit. Die App fügt sie an jedem Fälligkeitsdatum automatisch zur Liste hinzu. Mit dem Schalter pausierst du eine Regel, mit dem Stift bearbeitest du sie.',
    help_tx_csv_h:'CSV-Import',
    ...
    // Evio (KI-Assistentin)
    sett_penny_h:'Evio (KI-Budget-Assistentin)',
    sett_penny_desc:'Stelle Evio Fragen zu deinem Budget & deinen Ausgabengewohnheiten',
    sett_penny_toggle:'Evio aktivieren',
    sett_penny_hint:'Schaltet die Assistentin Evio und ihr Symbol in der Navigationsleiste ein.',
    ...
    sett_penny_available:'Evio ist jetzt im Navigationsmenü verfügbar.',
    sett_penny_usage_count:'Evio hat diesen Monat {0} Fragen beantwortet',
    sett_penny_key_error_short:'Das sieht nicht wie ein gültiger Schlüssel aus. Bitte überprüfen und erneut versuchen.',
    confirm_penny_remove_key:'Deinen gespeicherten Gemini API-Schlüssel entfernen? Evio wird deaktiviert, bis du einen neuen hinzufügst.',
    toast_penny_key_saved:'Gemini-Schlüssel sicher gespeichert.',
    penny_nav_pill_off:'Evio aktivieren',
    penny_nav_pill_on:'Evio fragen',
    penny_nav_aria_off:'Evio aktivieren',
    penny_nav_aria_on:'Evio fragen',
    penny_chat_title:'Evio fragen',
    penny_input_placeholder:'Frage zu deinem Budget…',
    penny_send:'Fragen',
    penny_thinking:'Evio überlegt…',
    ...
    penny_no_key_notice:'Füge deinen Gemini API-Schlüssel in den Einstellungen hinzu, um mit Evio zu chatten.',
    penny_open_settings:'Einstellungen öffnen',
    penny_close:'Evio schließen',
    ...
    penny_err_overloaded:'Der Gemini-Dienst von Google ist gerade vorübergehend überlastet. Bitte versuche es in Kürze erneut.',
    penny_err_network:'Evio konnte die Server von Google nicht erreichen. Überprüfe deine Verbindung und versuche es erneut.',
    penny_err_blocked:'Evio konnte darauf keine sichere Antwort finden. Versuche, deine Frage zum Budget anders zu formulieren.',
    penny_err_unknown:'Bei Evio ist etwas schiefgelaufen. Bitte versuche es gleich noch einmal.',
    ...
    help_sett_penny_p:'Schalte Evio unten ein, um Fragen zu deinem Budget in einfacher Sprache zu stellen. Tippe auf „So erstelle ich meinen Schlüssel“ für die Einrichtungsschritte.',
    help_penny_title:'Evio einrichten',
    help_penny_intro:'Evio ist der KI-Assistent von Evio Budget. Da diese App keinen eigenen Server hat, spricht Evio direkt von deinem Browser aus mit Google, über deinen eigenen kostenlosen Gemini API-Schlüssel. Es läuft nie über einen Evio-Budget-Server, denn den gibt es nicht.',
    ...
    help_penny_step4:'Füge ihn in das Feld „Gemini API-Schlüssel“ in den Einstellungen von Evio Budget ein und klicke auf „Schlüssel speichern“.',
    ...
    help_penny_safety_p:'Dein Schlüssel wird verschlüsselt, bevor er im Speicher deines eigenen Browsers gespeichert wird, und wird nur direkt an die API von Google gesendet, wenn du Evio eine Frage stellst. Er geht niemals an einen Server von Evio Budget.',
    ...
    guide_welcome_big:'Ultimate Budget Planner nimmt die einfache Idee, Einnahmen und Ausgaben zu verfolgen, und verleiht ihr Superkräfte - einen echten Tilgungsplan für Schulden, Sparziele mit Fortschrittsbalken, einen Kalender mit Rundumblick, eine Abo-Übersicht und Evio, eine KI-Assistentin, die deine Zahlen schon kennt. Starte mit dem Dashboard und erkunde den Rest, wann immer du bereit bist.',
    guide_dashboard_title:'Dashboard',
    ...
    guide_transactions_tip:'Richte zuerst wiederkehrende Regeln für deine regelmäßigen Rechnungen und dein Gehalt ein - das ist der größte Zeitspar-Trick der ganzen App.',guide_transactions_usecase_h:'So sieht das in der Praxis aus',guide_transactions_usecase_p:'<p><strong>Jack</strong> bekommt seine Netflix-Verlängerung auf seiner Karte abgebucht. Er öffnet Transaktionen, tippt auf <strong>+ Transaktion hinzufügen</strong>, wählt Ausgabe → Unterhaltung, gibt den Betrag ein, und sie ist in Sekunden erfasst.</p><p>Später, beim Aufräumen, bemerkt er mehrere doppelte Test-Einträge aus der Zeit, als er die App ausprobiert hat. Er wählt sie mit den Kästchen aus und tippt auf <strong>Auswahl löschen</strong>, um sie alle auf einmal zu entfernen, statt einzeln zu löschen.</p>',
    guide_budget_title:'Budget',
    ...
    guide_budget_tip:'Überprüfe deine erwarteten Beträge einmal im Monat - ein Budget, das sich nie ändert, spiegelt die Realität ziemlich schnell nicht mehr wider.',guide_budget_usecase_h:'So sieht das in der Praxis aus',guide_budget_usecase_p:'<p>Zu Monatsbeginn setzt <strong>Priya</strong> ihren erwarteten Betrag für Lebensmittel im Budget-Tab auf 500 €. Während sie im Laufe des Monats Transaktionen erfasst, füllt sich die Spalte Tatsächlich automatisch.</p><p>Der Fortschrittsbalken wechselt von Grün zu Orange, je näher sie ihrem Limit kommt - ein Hinweis, kürzerzutreten, bevor sie es überschreitet, statt es erst hinterher zu merken.</p>',
    ...
    guide_subscriptions_tip:'Mach die Abo-Überprüfung direkt nach deinem Kontoauszug jeden Monat - das ist der einfachste Zeitpunkt, um etwas zu entdecken, das du vergessen hattest zu bezahlen.',guide_subscriptions_usecase_h:'So sieht das in der Praxis aus',guide_subscriptions_usecase_p:'<p><strong>Jack</strong> fügt Netflix als Abo hinzu - 15,49 €, monatlich - und schaltet <strong>Automatisieren</strong> ein, damit es jeden Abrechnungszyklus automatisch als Transaktion erfasst wird, ohne dass er einen Finger rühren muss.</p><p>Sechs Monate später erhöht Netflix den Preis auf 17,99 €. Als Jack das Abo das nächste Mal bearbeitet, um es zu aktualisieren, notiert Evio Budget die Preiserhöhung im Stillen und zeigt ein kleines ↑ neben dem Betrag, damit er auf einen Blick sieht, welche Abos teurer geworden sind.</p>',
    ...
    guide_calendar_tip:'Wirf zu Beginn jeder Woche einen Blick in den Kalender - es dauert Sekunden und Fälligkeiten sind nie mehr eine Überraschung.',guide_calendar_usecase_h:'So sieht das in der Praxis aus',guide_calendar_usecase_p:'<p>Bevor er sich fürs Wochenende auf den Weg macht, prüft <strong>Amir</strong> den Kalender, um zu sehen, was diese Woche fällig ist. Er entdeckt, dass seine Stromrechnung am Montag fällig und noch unbezahlt ist.</p><p>Er bezahlt sie online und hakt sie dann direkt im Kalender ab, wobei er die tatsächlich gezahlten 87,40 € einträgt - erfasst, ohne den Tab wechseln zu müssen.</p>',
    ...
    guide_automation_tip:'Schalte die Automatisierung ein, sobald sich deine wiederkehrenden Regeln korrekt anfühlen - sie ist am nützlichsten, sobald du den Zahlen vertraust, die sie bucht.',guide_automation_usecase_h:'So sieht das in der Praxis aus',guide_automation_usecase_p:'<p><strong>Tom</strong> hat drei Dinge, die sich jeden Monat wiederholen: Miete, seine Autokreditrate und ein Netflix-Abo. Statt alle drei jede Periode von Hand einzutragen, schaltet er für jedes <strong>Automatisieren</strong> ein.</p><p>Jedes Mal, wenn er die App in einer neuen Periode öffnet, hat Evio Budget sie bereits planmäßig als Transaktionen erfasst, und Tom muss nur noch prüfen, was neu ist, statt Routinemäßiges erneut einzutragen.</p>',
    guide_penny_title:'Evio',
    guide_penny_big:'Evio ist deine eigene KI-Budget-Assistentin, direkt in die App eingebaut - stell ihr eine Frage zu deinem Geld in normaler Sprache, und sie liest deine echten Budgetdaten, um dir eine echte Antwort zu geben, bei Bedarf mit Diagrammen.',
    guide_penny_step1:'Öffne die <strong>Einstellungen</strong>, aktiviere Evio und füge deinen eigenen Gemini-API-Schlüssel ein (dort findest du auch einen Link, der genau zeigt, wie du einen kostenlos bekommst).',
    ...
    guide_penny_connect1:'Evio kann deine Budgetdaten nur lesen, um Fragen zu beantworten - sie kann nie etwas für dich hinzufügen, ändern oder löschen.',
    ...
    guide_penny_connect3:'Dein API-Schlüssel wird verschlüsselt und nur auf deinem eigenen Gerät gespeichert - er wird nirgendwohin gesendet außer direkt an Google, wenn du Evio eine Frage stellst.',
    guide_penny_tip:'Starte beim ersten Mal mit einer der Schnellfragen-Schaltflächen - so siehst du am schnellsten, was sie kann, bevor du eigene Fragen stellst.',guide_penny_usecase_h:'So sieht das in der Praxis aus',guide_penny_usecase_p:'<p>Immer wenn <strong>Diane</strong> nicht sicher ist, wofür sie diesen Monat Geld ausgegeben hat, öffnet sie Evio und fragt: "Warum sind meine Ausgaben diesen Monat höher als sonst?"</p><p>Evio schaut sich ihre tatsächlichen Transaktionen an und gibt ihr eine verständliche Antwort - zum Beispiel, dass sich die Ausgaben fürs Essengehen verdoppelt haben - statt dass sie selbst die Transaktionsliste durchsuchen muss.</p>',
    ...
    guide_settings_tip:'Richte zuerst Währung, Budgetzeitraum und Daten & Sync ein, bevor du etwas anderes tust - sie sind das Fundament, auf dem alles andere in der App aufbaut.',guide_settings_usecase_h:'So sieht das in der Praxis aus',guide_settings_usecase_p:'<p>Als <strong>Ben</strong> in die Selbstständigkeit wechselt, stimmt sein Einkommen nicht mehr mit dem Kalendermonat überein. Er öffnet die Einstellungen und ändert seinen Budgetzeitraum auf einen benutzerdefinierten Zeitraum, der zu seinem tatsächlichen Zahlungszyklus passt.</p><p>Er wählt USD als Währung und schaltet vorübergehend den Hauptschalter für die Automatisierung aus, während er sein Budget komplett neu plant.</p>',
  ...
  fr: {
    ...
    help_sf_reading_p:'Chaque carte affiche votre épargne vs objectif, une barre de progression et exactement combien épargner par mois pour atteindre votre objectif à temps. À 100 %, un badge « Objectif atteint » apparaît sur la carte.',
    ...
    help_tx_edit_p:'Cliquez sur \u270F\uFE0F pour modifier une transaction, ou \u00d7 pour la supprimer. Pour tout effacer, utilisez « Tout effacer ».',help_tx_bulk_h:'Sélectionner plusieurs transactions',help_tx_bulk_p:"Cochez la case à côté d'une transaction pour la sélectionner, ou utilisez la case dans l'en-tête pour sélectionner toute la page. Si votre recherche ou filtre correspond à plusieurs pages, un lien « Tout sélectionner » vous permet de récupérer tous les résultats d'un coup, puis de les supprimer ensemble.",help_tx_auto_h:'Transactions automatiques',help_tx_auto_p:"Créez une règle pour tout ce qui se répète (loyer, salaire) et choisissez la fréquence. L'app l'ajoute automatiquement à votre liste à chaque échéance. Utilisez l'interrupteur pour mettre en pause, ou le crayon pour modifier.",
    ...
    // Evio (assistante IA)
    sett_penny_h:'Evio (Assistante budgétaire IA)',
    sett_penny_desc:'Posez des questions à Evio sur votre budget & vos habitudes de dépenses',
    sett_penny_toggle:'Activer Evio',
    sett_penny_hint:'Active l’assistante Evio et son icône dans la barre de navigation.',
    ...
    sett_penny_available:'Evio est maintenant disponible dans le menu de navigation.',
    sett_penny_usage_count:'Evio a répondu à {0} questions ce mois-ci',
    sett_penny_key_error_short:'Cela ne ressemble pas à une clé valide. Vérifiez et réessayez.',
    confirm_penny_remove_key:'Supprimer votre clé API Gemini enregistrée ? Evio sera désactivée jusqu’à ce que vous en ajoutiez une nouvelle.',
    toast_penny_key_saved:'Clé Gemini enregistrée en toute sécurité.',
    penny_nav_pill_off:'Activer Evio',
    penny_nav_pill_on:'Demander à Evio',
    penny_nav_aria_off:'Activer Evio',
    penny_nav_aria_on:'Demander à Evio',
    penny_chat_title:'Demander à Evio',
    penny_input_placeholder:'Posez une question sur votre budget…',
    penny_send:'Demander',
    penny_thinking:'Evio réfléchit…',
    ...
    penny_no_key_notice:'Ajoutez votre clé API Gemini dans les Paramètres pour commencer à discuter avec Evio.',
    penny_open_settings:'Ouvrir les paramètres',
    penny_close:'Fermer Evio',
    ...
    penny_err_overloaded:'Le service Gemini de Google est temporairement surchargé. Veuillez réessayer dans un instant.',
    penny_err_network:'Evio n’a pas pu joindre les serveurs de Google. Vérifiez votre connexion et réessayez.',
    penny_err_blocked:'Evio n’a pas trouvé de réponse sûre à cela. Essayez de reformuler votre question sur votre budget.',
    penny_err_unknown:'Une erreur s’est produite du côté de Evio. Veuillez réessayer dans un instant.',
    ...
    help_sett_penny_p:'Activez Evio ci-dessous pour poser des questions sur votre budget en langage simple. Touchez « Comment créer ma clé » pour les étapes de configuration.',
    help_penny_title:'Configurer Evio',
    help_penny_intro:'Evio est l’assistante IA d’Evio Budget. Comme cette application n’a pas de serveur, Evio parle directement depuis votre navigateur à Google grâce à votre propre clé API Gemini gratuite. Rien ne transite jamais par un serveur Evio Budget, puisqu’il n’y en a pas.',
    ...
    help_penny_step4:'Collez-la dans le champ « Clé API Gemini » des Paramètres d’Evio Budget et cliquez sur « Enregistrer la clé ».',
    ...
    help_penny_safety_p:'Votre clé est chiffrée avant d’être enregistrée dans le stockage de votre propre navigateur, et elle n’est envoyée directement à l’API de Google que lorsque vous posez une question à Evio. Elle ne va jamais à un serveur d’Evio Budget.',
    ...
    guide_dashboard_tip:"Prenez 30 secondes chaque matin pour parcourir le tableau de bord - c'est le moyen le plus rapide de repérer une facture ou un paiement de dette avant qu'il ne soit en retard.",guide_dashboard_usecase_h:'Un exemple concret',guide_dashboard_usecase_p:"<p><strong>Maria</strong> ouvre Evio Budget le jour de paie. Elle jette un œil au tableau de bord et voit que son solde net pour cette période est de 420 € - assez pour ajouter un peu plus à son fonds d'urgence.</p><p>Le panneau de flux de trésorerie montre qu'elle dépasse déjà son budget Restaurants, alors elle renonce à commander à emporter ce soir-là au lieu de le découvrir à la fin du mois.</p>",
    guide_transactions_title:'Transactions',
    ...
    guide_transactions_tip:"Configurez d'abord les règles récurrentes pour vos factures régulières et votre salaire - c'est le plus grand gain de temps de toute l'application.",guide_transactions_usecase_h:'Un exemple concret',guide_transactions_usecase_p:"<p><strong>Jack</strong> voit le renouvellement de son abonnement Netflix débité sur sa carte. Il ouvre Transactions, appuie sur <strong>+ Ajouter une transaction</strong>, choisit Dépense → Divertissement, saisit le montant, et c'est enregistré en quelques secondes.</p><p>Plus tard, en faisant du tri, il remarque plusieurs entrées de test en double datant de ses essais de l'application. Il les sélectionne avec les cases à cocher et appuie sur <strong>Supprimer la sélection</strong> pour toutes les effacer d'un coup au lieu de les supprimer une par une.</p>",
    guide_budget_title:'Budget',
    ...
    guide_budget_tip:"Revoyez vos montants Prévus une fois par mois - un budget qui ne change jamais cesse assez vite de refléter la réalité.",guide_budget_usecase_h:'Un exemple concret',guide_budget_usecase_p:"<p>En début de mois, <strong>Priya</strong> fixe son montant prévu pour l'Épicerie à 500 € dans l'onglet Budget. Au fil du mois, à mesure qu'elle saisit des transactions, la colonne Réel se remplit automatiquement.</p><p>La barre de progression passe du vert à l'orange à mesure qu'elle approche de sa limite - un signal pour lever le pied avant de la dépasser, au lieu de le découvrir après coup.</p>",
    ...
    guide_debt_tip:"Listez même les petites dettes, comme un prêt familial - ce qui compte n'est pas le montant, mais de savoir tout ce que vous devez au même endroit.",guide_debt_usecase_h:'Un exemple concret',guide_debt_usecase_p:"<p><strong>Sam</strong> a trois dettes : une carte de crédit, un prêt auto et un petit prêt personnel. Il les saisit toutes les trois, choisit Avalanche pour que la carte au taux le plus élevé soit remboursée en premier, et voit immédiatement sa date de remboursement réelle et le total des intérêts.</p><p>Quand il reçoit une prime au travail, il la saisit dans le champ <strong>Extra/mois</strong> de cette carte précise plutôt que dans le pool commun de paiements supplémentaires, pour que la prime aille exactement là où il le souhaite - puis il ouvre l'échéancier ℹ️ pour voir mois par mois à quel point il sera libéré de ses dettes plus vite.</p>",
    ...
    guide_sinking_tip:"Découpez les grands objectifs en montants mensuels ronds - il est bien plus facile de s'engager à 50 € par mois que de « économiser pour des vacances un jour ».",guide_sinking_usecase_h:'Un exemple concret',guide_sinking_usecase_p:"<p><strong>Elena</strong> prépare des vacances à 1 200 € pour juillet prochain. Elle crée une Réserve avec ce montant cible et cette date, et Evio Budget lui indique qu'elle doit épargner 150 €/mois pour y arriver.</p><p>Elle active <strong>Automatiser</strong> pour que ce montant soit enregistré comme contribution chaque mois sans qu'elle ait besoin d'y penser.</p>",
    ...
    guide_subscriptions_tip:"Faites une revue de vos abonnements juste après la réception de votre relevé bancaire chaque mois - c'est le moment le plus facile pour repérer quelque chose que vous aviez oublié de payer.",guide_subscriptions_usecase_h:'Un exemple concret',guide_subscriptions_usecase_p:"<p><strong>Jack</strong> ajoute Netflix comme abonnement - 15,49 €, mensuel - et active <strong>Automatiser</strong> pour qu'il soit enregistré comme transaction à chaque cycle de facturation sans qu'il ait à lever le petit doigt.</p><p>Six mois plus tard, Netflix augmente son prix à 17,99 €. La prochaine fois que Jack modifie l'abonnement pour le mettre à jour, Evio Budget note discrètement la hausse de prix et affiche une petite flèche ↑ à côté du montant, pour qu'il repère d'un coup d'œil les abonnements qui ont augmenté.</p>",
    ...
    guide_calendar_tip:"Consultez le Calendrier en début de semaine - cela prend quelques secondes et les échéances ne sont plus jamais une surprise.",guide_calendar_usecase_h:'Un exemple concret',guide_calendar_usecase_p:"<p>Avant de partir pour le week-end, <strong>Amir</strong> consulte le Calendrier pour voir ce qui est dû cette semaine. Il remarque que sa facture d'électricité est due lundi et toujours impayée.</p><p>Il la règle en ligne, puis coche directement la case sur le calendrier en saisissant les 87,40 € réellement payés - enregistré sans avoir à changer d'onglet.</p>",
    ...
    guide_rollover_tip:"Si un gros montant de report vous brûle les doigts, envisagez d'en transférer une partie vers une Réserve pour qu'il soit destiné à quelque chose de précis.",guide_rollover_usecase_h:'Un exemple concret',guide_rollover_usecase_p:"<p>Fin juin, il reste à <strong>Noor</strong> 180 € après avoir tout couvert. Comme le <strong>Report automatique</strong> est activé, dès qu'elle fait passer sa période budgétaire à juillet, ces 180 € apparaissent automatiquement comme son report - ajoutés directement à son solde net, sans qu'elle ait à les calculer et les ressaisir elle-même.</p>",
    ...
    guide_automation_tip:"Activez l'Automatisation une fois que vos règles récurrentes vous semblent justes - elle est surtout utile une fois que vous faites confiance aux chiffres qu'elle va saisir.",guide_automation_usecase_h:'Un exemple concret',guide_automation_usecase_p:"<p><strong>Tom</strong> a trois choses qui reviennent chaque mois : le loyer, sa mensualité de prêt auto et un abonnement Netflix. Plutôt que de les saisir à la main chaque période, il active <strong>Automatiser</strong> pour chacune.</p><p>Chaque fois qu'il ouvre l'application sur une nouvelle période, Evio Budget les a déjà enregistrées comme transactions selon le calendrier prévu, et Tom n'a plus qu'à vérifier ce qui est nouveau au lieu de ressaisir ce qui est routinier.</p>",
    guide_penny_title:'Evio',
    guide_penny_big:"Evio est votre propre assistante IA pour le budget, intégrée directement à l'application - posez-lui une question sur votre argent en langage courant, et elle lit vos vraies données budgétaires pour vous donner une vraie réponse, avec des graphiques quand c'est utile.",
    guide_penny_step1:"Ouvrez les <strong>Paramètres</strong>, activez Evio, et collez votre propre clé API Gemini (un lien est juste là pour montrer exactement comment en obtenir une gratuitement).",
    ...
    guide_penny_connect1:"Evio ne peut que lire vos données budgétaires pour répondre aux questions - elle ne peut jamais rien ajouter, modifier ou supprimer pour vous.",
    ...
    guide_penny_connect3:"Votre clé API est chiffrée et stockée uniquement sur votre propre appareil - elle n'est jamais envoyée nulle part, sauf directement à Google quand vous posez une question à Evio.",
    guide_penny_tip:"Commencez par l'un des boutons de question rapide la première fois - c'est le moyen le plus rapide de voir ce qu'elle sait faire avant de poser vos propres questions.",guide_penny_usecase_h:'Un exemple concret',guide_penny_usecase_p:'<p>Chaque fois que <strong>Diane</strong> ne sait plus où est passé son argent ce mois-ci, elle ouvre Evio et demande « pourquoi mes dépenses sont-elles plus élevées que d\'habitude ce mois-ci ? »</p><p>Evio examine ses transactions réelles et lui donne une réponse en langage simple - en signalant, par exemple, que ses dépenses en Restaurants ont doublé - au lieu qu\'elle doive fouiller elle-même dans la liste des transactions.</p>',
    ...
    guide_settings_tip:"Configurez d'abord Devise, Période budgétaire et Données et synchronisation, avant tout le reste - ce sont les fondations sur lesquelles tout le reste de l'application est construit.",guide_settings_usecase_h:'Un exemple concret',guide_settings_usecase_p:"<p>Quand <strong>Ben</strong> passe au travail indépendant, ses revenus ne correspondent plus au mois calendaire. Il ouvre Paramètres et change sa Période budgétaire pour une plage de dates personnalisée qui correspond à son cycle de paie réel.</p><p>Il choisit l'USD comme devise et désactive temporairement l'interrupteur principal d'Automatisation pendant qu'il replanifie son budget depuis le début.</p>",
  ...
  es: {
    ...
    help_sf_reading_p:'Cada tarjeta muestra tu ahorro vs objetivo, una barra de progreso y exactamente cuánto ahorrar por mes para alcanzar tu meta a tiempo. Al llegar al 100%, aparece en la tarjeta la insignia "Objetivo alcanzado".',
    ...
    help_tx_edit_p:'Haz clic en \u270F\uFE0F en cualquier transacción para editarla, o \u00d7 para eliminarla. Para borrar todo, usa «Borrar todo».',help_tx_bulk_h:'Seleccionar varias transacciones',help_tx_bulk_p:'Marca la casilla junto a una transacción para seleccionarla, o usa la casilla del encabezado para seleccionar toda la página. Si tu búsqueda o filtro abarca más de una página, un enlace "Seleccionar todas las coincidentes" te permite tomar todos los resultados a la vez y eliminarlos juntos.',help_tx_auto_h:'Transacciones automáticas',help_tx_auto_p:'Crea una regla para todo lo que se repite (como alquiler o salario) y elige la frecuencia. La app la añade a tu lista automáticamente en cada vencimiento. Usa el interruptor para pausar una regla, o el lápiz para editarla.',
    ...
    // Evio (asistente IA)
    sett_penny_h:'Evio (Asistente de presupuesto con IA)',
    sett_penny_desc:'Pregúntale a Evio sobre tu presupuesto & tus hábitos de gasto',
    sett_penny_toggle:'Activar Evio',
    sett_penny_hint:'Activa la asistente Evio y su icono en la barra de navegación.',
    ...
    sett_penny_available:'Evio ya está disponible en el menú de navegación.',
    sett_penny_usage_count:'Evio ha respondido {0} preguntas este mes',
    sett_penny_key_error_short:'Eso no parece una clave válida. Revísala e inténtalo de nuevo.',
    confirm_penny_remove_key:'¿Eliminar tu clave de API de Gemini guardada? Evio se desactivará hasta que agregues una nueva.',
    toast_penny_key_saved:'Clave de Gemini guardada de forma segura.',
    penny_nav_pill_off:'Activar Evio',
    penny_nav_pill_on:'Preguntar a Evio',
    penny_nav_aria_off:'Activar Evio',
    penny_nav_aria_on:'Preguntar a Evio',
    penny_chat_title:'Preguntar a Evio',
    penny_input_placeholder:'Pregunta sobre tu presupuesto…',
    penny_send:'Preguntar',
    penny_thinking:'Evio está pensando…',
    ...
    penny_no_key_notice:'Añade tu clave de API de Gemini en Ajustes para empezar a chatear con Evio.',
    penny_open_settings:'Abrir ajustes',
    penny_close:'Cerrar Evio',
    ...
    penny_err_overloaded:'El servicio Gemini de Google está temporalmente saturado en este momento. Inténtalo de nuevo en un momento.',
    penny_err_network:'Evio no pudo conectarse con los servidores de Google. Revisa tu conexión e inténtalo de nuevo.',
    penny_err_blocked:'Evio no pudo dar una respuesta segura a eso. Intenta reformular tu pregunta sobre tu presupuesto.',
    penny_err_unknown:'Algo salió mal del lado de Evio. Inténtalo de nuevo en un momento.',
    penny_err_key_unreadable:'No se pudo leer tu clave guardada. Vuelve a introducirla en Ajustes.',
    penny_err_retry:'Reintentar',
    help_sett_penny_p:'Activa Evio abajo para hacer preguntas sobre tu presupuesto en lenguaje sencillo. Toca «Cómo crear mi clave» para ver los pasos de configuración.',
    help_penny_title:'Configurar a Evio',
    help_penny_intro:'Evio es la asistente de IA de Evio Budget. Como esta app no tiene servidor propio, Evio habla directamente desde tu navegador con Google usando tu propia clave de API de Gemini gratuita. Nada pasa nunca por un servidor de Evio Budget, porque no existe ninguno.',
    ...
    help_penny_step4:'Pégala en el campo «Clave de API de Gemini» en los Ajustes de Evio Budget y haz clic en «Guardar clave».',
    ...
    help_penny_safety_p:'Tu clave se cifra antes de guardarse en el almacenamiento de tu propio navegador, y solo se envía directamente a la API de Google cuando le haces una pregunta a Evio. Nunca se envía a un servidor de Evio Budget.',
    ...
    guide_transactions_tip:'Configura primero las reglas recurrentes para tus facturas habituales y tu sueldo - es el mayor ahorro de tiempo de toda la app.',guide_transactions_usecase_h:'Así se usa en la práctica',guide_transactions_usecase_p:'<p>A <strong>Jack</strong> le cobran la renovación de Netflix en su tarjeta. Abre Transacciones, toca <strong>+ Añadir transacción</strong>, elige Gasto → Entretenimiento, escribe el importe, y queda registrado en segundos.</p><p>Más tarde, haciendo limpieza, se da cuenta de varias entradas de prueba duplicadas de cuando estaba probando la app. Las selecciona con las casillas y toca <strong>Eliminar seleccionadas</strong> para borrarlas todas de una vez en lugar de una por una.</p>',
    ...
    guide_budget_tip:'Revisa tus importes Esperados una vez al mes - un presupuesto que nunca cambia deja de reflejar la realidad bastante rápido.',guide_budget_usecase_h:'Así se usa en la práctica',guide_budget_usecase_p:'<p>Al empezar el mes, <strong>Priya</strong> fija su importe esperado para Comestibles en 500 € en la pestaña Presupuesto. A medida que registra transacciones durante el mes, la columna Real se rellena automáticamente.</p><p>La barra de progreso pasa de verde a naranja cuando se acerca a su límite - avisándole para frenar antes de pasarse, en lugar de descubrirlo después.</p>',
    ...
    guide_subscriptions_tip:'Haz una revisión de suscripciones justo después de recibir tu estado de cuenta cada mes - es el momento más fácil para detectar algo que olvidaste que estabas pagando.',guide_subscriptions_usecase_h:'Así se usa en la práctica',guide_subscriptions_usecase_p:'<p><strong>Jack</strong> añade Netflix como suscripción - 15,49 €, mensual - y activa <strong>Automatizar</strong> para que se registre como transacción en cada ciclo de facturación sin que tenga que mover un dedo.</p><p>Seis meses después, Netflix sube el precio a 17,99 €. La siguiente vez que Jack edita la suscripción para actualizarla, Evio Budget anota discretamente la subida de precio y muestra una pequeña ↑ junto al importe, para que vea de un vistazo qué suscripciones han subido de precio.</p>',
    ...
    guide_calendar_tip:'Revisa el Calendario al inicio de cada semana - toma unos segundos y los vencimientos ya nunca son una sorpresa.',guide_calendar_usecase_h:'Así se usa en la práctica',guide_calendar_usecase_p:'<p>Antes de salir el fin de semana, <strong>Amir</strong> revisa el Calendario para ver qué vence esta semana. Ve que su factura de electricidad vence el lunes y sigue sin pagar.</p><p>La paga en línea y luego marca la casilla ahí mismo en el calendario, escribiendo los 87,40 € que realmente pagó - registrado sin tener que cambiar de pestaña.</p>',
    ...
    guide_automation_tip:'Activa la Automatización una vez que tus reglas recurrentes te parezcan correctas - es más útil cuando confías en los números que va a registrar.',guide_automation_usecase_h:'Así se usa en la práctica',guide_automation_usecase_p:'<p><strong>Tom</strong> tiene tres cosas que se repiten cada mes: el alquiler, la cuota de su préstamo de coche y una suscripción a Netflix. En lugar de escribir las tres a mano cada período, activa <strong>Automatizar</strong> en cada una.</p><p>Cada vez que abre la app en un nuevo período, Evio Budget ya las ha registrado como transacciones según lo previsto, y Tom solo necesita revisar lo nuevo en lugar de volver a introducir lo rutinario.</p>',
    guide_penny_title:'Evio',
    guide_penny_big:'Evio es tu propia asistente de IA para el presupuesto, integrada directamente en la app - hazle una pregunta sobre tu dinero en lenguaje sencillo, y ella lee tus datos reales de presupuesto para darte una respuesta real, con gráficos cuando ayuda.',
    guide_penny_step1:'Abre <strong>Ajustes</strong>, activa Evio, y pega tu propia clave de API de Gemini (hay un enlace justo ahí que muestra exactamente cómo conseguir una gratis).',
    ...
    guide_penny_connect1:'Evio solo puede leer tus datos de presupuesto para responder preguntas - nunca puede agregar, editar ni eliminar nada por ti.',
    ...
    guide_penny_connect3:'Tu clave de API se cifra y se guarda solo en tu propio dispositivo - nunca se envía a ningún lado excepto directamente a Google cuando le haces una pregunta a Evio.',
    guide_penny_tip:'Empieza con uno de los botones de pregunta rápida la primera vez - es la forma más rápida de ver lo que puede hacer antes de hacer tus propias preguntas.',guide_penny_usecase_h:'Así se usa en la práctica',guide_penny_usecase_p:'<p>Cada vez que <strong>Diane</strong> no está segura de en qué se le fue el dinero este mes, abre Evio y pregunta "¿por qué mi gasto es más alto de lo normal este mes?"</p><p>Evio examina sus transacciones reales y le da una respuesta en lenguaje sencillo - señalando, por ejemplo, que el gasto en Restaurantes se ha duplicado - en lugar de tener que revisar ella misma la lista de transacciones.</p>',
    ...
    guide_settings_tip:'Configura Moneda, Período de presupuesto y Datos y sincronización primero, antes que cualquier otra cosa - son la base sobre la que se construye todo lo demás en la app.',guide_settings_usecase_h:'Así se usa en la práctica',guide_settings_usecase_p:'<p>Cuando <strong>Ben</strong> pasa a trabajar por cuenta propia, sus ingresos ya no coinciden con el mes natural. Abre Ajustes y cambia su Período de presupuesto a un rango de fechas personalizado que coincide con su ciclo de pago real.</p><p>Elige USD como moneda y desactiva temporalmente el interruptor principal de Automatización mientras replanifica su presupuesto desde cero.</p>',
  ...
  it: {
    ...
    help_sf_reading_p:'Ogni scheda mostra il tuo risparmio vs obiettivo, una barra di avanzamento e esattamente quanto risparmiare al mese per raggiungere il tuo obiettivo in tempo. Al 100% appare sulla scheda il badge "Obiettivo raggiunto".',
    ...
    help_tx_edit_p:'Clicca \u270F\uFE0F su qualsiasi transazione per modificarla, o \u00d7 per eliminarla. Per cancellare tutto, usa "Cancella tutto".',help_tx_bulk_h:'Selezionare più transazioni',help_tx_bulk_p:'Seleziona la casella accanto a una transazione per sceglierla, oppure usa la casella nell’intestazione per selezionare l’intera pagina. Se la tua ricerca o il filtro coprono più pagine, il link "Seleziona tutte le corrispondenti" ti permette di prenderle tutte insieme e poi eliminarle.',help_tx_auto_h:'Transazioni automatiche',help_tx_auto_p:"Crea una regola per tutto ciò che si ripete (come affitto o stipendio) e scegli la frequenza. L'app la aggiunge automaticamente alla lista a ogni scadenza. Usa l'interruttore per mettere in pausa, o la matita per modificare.",
    help_tx_csv_h:'Import CSV',
    ...
    // Evio (assistente IA)
    sett_penny_h:'Evio (Assistente di budget IA)',
    sett_penny_desc:'Chiedi a Evio del tuo budget & delle tue abitudini di spesa',
    sett_penny_toggle:'Attiva Evio',
    sett_penny_hint:'Attiva l’assistente Evio e la sua icona nella barra di navigazione.',
    ...
    sett_penny_available:'Evio è ora disponibile nel menu di navigazione.',
    sett_penny_usage_count:'Evio ha risposto a {0} domande questo mese',
    sett_penny_key_error_short:'Non sembra una chiave valida. Controlla e riprova.',
    confirm_penny_remove_key:'Rimuovere la chiave API Gemini salvata? Evio verrà disattivata finché non ne aggiungi una nuova.',
    toast_penny_key_saved:'Chiave Gemini salvata in modo sicuro.',
    penny_nav_pill_off:'Attiva Evio',
    penny_nav_pill_on:'Chiedi a Evio',
    penny_nav_aria_off:'Attiva Evio',
    penny_nav_aria_on:'Chiedi a Evio',
    penny_chat_title:'Chiedi a Evio',
    penny_input_placeholder:'Fai una domanda sul tuo budget…',
    penny_send:'Chiedi',
    penny_thinking:'Evio sta pensando…',
    ...
    penny_no_key_notice:'Aggiungi la tua chiave API Gemini nelle Impostazioni per iniziare a chattare con Evio.',
    penny_open_settings:'Apri Impostazioni',
    penny_close:'Chiudi Evio',
    ...
    penny_err_overloaded:'Il servizio Gemini di Google è temporaneamente sovraccarico in questo momento. Riprova tra un momento.',
    penny_err_network:'Evio non è riuscita a raggiungere i server di Google. Controlla la connessione e riprova.',
    penny_err_blocked:'Evio non è riuscita a trovare una risposta sicura. Prova a riformulare la tua domanda sul budget.',
    penny_err_unknown:'Qualcosa è andato storto dal lato di Evio. Riprova tra un momento.',
    ...
    help_sett_penny_p:'Attiva Evio qui sotto per fare domande sul tuo budget in linguaggio semplice. Tocca «Come creare la mia chiave» per i passaggi di configurazione.',
    help_penny_title:'Configurare Evio',
    help_penny_intro:'Evio è l’assistente IA di Evio Budget. Poiché questa app non ha un proprio server, Evio parla direttamente dal tuo browser con Google usando la tua chiave API Gemini gratuita. Nulla passa mai da un server di Evio Budget, perché non ne esiste uno.',
    ...
    help_penny_step4:'Incollala nel campo «Chiave API Gemini» nelle Impostazioni di Evio Budget e fai clic su «Salva chiave».',
    ...
    help_penny_safety_p:'La tua chiave viene crittografata prima di essere salvata nell’archivio del tuo browser, e viene inviata direttamente all’API di Google solo quando fai una domanda a Evio. Non viene mai inviata a un server di Evio Budget.',
    ...
    guide_welcome_big:"Ultimate Budget Planner prende l'idea semplice di tracciare entrate e uscite e le dà superpoteri - un vero piano di rimborso debiti, obiettivi di risparmio con barre di progresso, un calendario con vista d'insieme, tracciamento degli abbonamenti e Evio, un'assistente IA che conosce già i tuoi numeri. Inizia dalla Dashboard ed esplora il resto quando sei pronto.",
    guide_dashboard_title:"Dashboard",
    ...
    guide_transactions_tip:"Configura prima le regole ricorrenti per le tue bollette abituali e il tuo stipendio - è il più grande risparmio di tempo di tutta l'app.",guide_transactions_usecase_h:'Un esempio pratico',guide_transactions_usecase_p:"<p>A <strong>Jack</strong> viene addebitato il rinnovo di Netflix sulla carta. Apre Transazioni, tocca <strong>+ Aggiungi transazione</strong>, sceglie Spesa → Intrattenimento, digita l'importo, ed è registrato in pochi secondi.</p><p>Più tardi, facendo pulizia, nota diverse voci di prova duplicate da quando stava provando l'app. Le seleziona con le caselle e tocca <strong>Elimina selezionate</strong> per cancellarle tutte insieme invece che una per una.</p>",
    guide_budget_title:"Budget",
    ...
    guide_budget_tip:"Rivedi i tuoi importi Previsti una volta al mese - un budget che non cambia mai smette abbastanza rapidamente di riflettere la realtà.",guide_budget_usecase_h:'Un esempio pratico',guide_budget_usecase_p:"<p>All'inizio del mese, <strong>Priya</strong> imposta l'importo previsto per la Spesa a 500 € nella scheda Budget. Man mano che registra transazioni durante il mese, la colonna Effettivo si aggiorna automaticamente.</p><p>La barra di avanzamento passa dal verde all'arancione quando si avvicina al limite - un segnale per rallentare prima di superarlo, invece di scoprirlo dopo.</p>",
    ...
    guide_subscriptions_tip:"Fai una revisione degli abbonamenti subito dopo aver ricevuto l'estratto conto ogni mese - è il momento più facile per notare qualcosa che avevi dimenticato di pagare.",guide_subscriptions_usecase_h:'Un esempio pratico',guide_subscriptions_usecase_p:"<p><strong>Jack</strong> aggiunge Netflix come abbonamento - 15,49 €, mensile - e attiva <strong>Automatizza</strong> in modo che venga registrato come transazione a ogni ciclo di fatturazione senza muovere un dito.</p><p>Sei mesi dopo, Netflix aumenta il prezzo a 17,99 €. La volta successiva che Jack modifica l'abbonamento per aggiornarlo, Evio Budget annota silenziosamente l'aumento di prezzo e mostra una piccola ↑ accanto all'importo, così può vedere a colpo d'occhio quali abbonamenti sono aumentati.</p>",
    guide_calendar_title:"Calendario",
    ...
    guide_calendar_tip:"Controlla il Calendario a inizio settimana - richiede pochi secondi e le scadenze non sono più una sorpresa.",guide_calendar_usecase_h:'Un esempio pratico',guide_calendar_usecase_p:"<p>Prima di partire per il weekend, <strong>Amir</strong> controlla il Calendario per vedere cosa scade questa settimana. Nota che la bolletta della luce scade lunedì ed è ancora non pagata.</p><p>La paga online, poi spunta la casella direttamente sul calendario inserendo gli 87,40 € effettivamente pagati - registrato senza dover cambiare scheda.</p>",
    ...
    guide_automation_tip:"Attiva l'Automazione una volta che le tue regole ricorrenti ti sembrano corrette - è più utile quando ti fidi dei numeri che registrerà.",guide_automation_usecase_h:'Un esempio pratico',guide_automation_usecase_p:"<p><strong>Tom</strong> ha tre cose che si ripetono ogni mese: l'affitto, la rata del prestito auto e un abbonamento Netflix. Invece di inserirle tutte e tre a mano ogni periodo, attiva <strong>Automatizza</strong> per ciascuna.</p><p>Ogni volta che apre l'app in un nuovo periodo, Evio Budget le ha già registrate come transazioni secondo il programma, e Tom deve solo controllare cosa c'è di nuovo invece di reinserire ciò che è di routine.</p>",
    guide_penny_title:"Evio",
    guide_penny_big:"Evio è la tua assistente IA personale per il budget, integrata direttamente nell'app - fai una domanda sul tuo denaro in linguaggio semplice, e lei legge i tuoi dati di budget reali per darti una risposta reale, con grafici quando è utile.",
    guide_penny_step1:"Apri le <strong>Impostazioni</strong>, attiva Evio, e incolla la tua chiave API Gemini personale (c'è un link proprio lì che mostra esattamente come ottenerne una gratis).",
    ...
    guide_penny_connect1:"Evio può solo leggere i tuoi dati di budget per rispondere alle domande - non può mai aggiungere, modificare o eliminare nulla per te.",
    ...
    guide_penny_connect3:"La tua chiave API viene cifrata e conservata solo sul tuo dispositivo - non viene mai inviata da nessuna parte tranne direttamente a Google quando fai una domanda a Evio.",
    guide_penny_tip:"Inizia con uno dei pulsanti di domanda rapida la prima volta - è il modo più veloce per vedere cosa sa fare prima di fare domande tue.",guide_penny_usecase_h:'Un esempio pratico',guide_penny_usecase_p:'<p>Ogni volta che <strong>Diane</strong> non è sicura di dove sia finito il suo denaro questo mese, apre Evio e chiede "perché le mie spese sono più alte del solito questo mese?"</p><p>Evio esamina le sue transazioni reali e le dà una risposta in linguaggio semplice - segnalando, ad esempio, che la spesa per i Ristoranti è raddoppiata - invece di doversi mettere a scavare da sola nell\'elenco delle transazioni.</p>',
    ...
    guide_settings_tip:"Configura Valuta, Periodo di budget e Dati e sincronizzazione per prima cosa, prima di tutto il resto - sono le fondamenta su cui è costruito tutto il resto dell'app.",guide_settings_usecase_h:'Un esempio pratico',guide_settings_usecase_p:"<p>Quando <strong>Ben</strong> passa al lavoro autonomo, il suo reddito non coincide più con il mese di calendario. Apre Impostazioni e cambia il suo Periodo di budget in un intervallo di date personalizzato che corrisponde al suo ciclo di pagamento reale.</p><p>Sceglie USD come valuta e disattiva temporaneamente l'interruttore principale dell'Automazione mentre ripianifica il budget da zero.</p>",
  ...
  pl: {
    ...
    help_sf_reading_p:'Każda karta pokazuje zaoszczędzone vs cel, pasek postępu i dokładnie ile oszczędzać miesięcznie, aby osiągnąć cel na czas. Po osiągnięciu 100% na karcie pojawia się odznaka „Cel osiągnięty".',
    ...
    help_tx_edit_p:'Kliknij \u270F\uFE0F na dowolnej transakcji, aby ją edytować, lub \u00d7, aby ją usunąć. Aby usunąć wszystko, użyj „Wyczyść wszystko".',help_tx_bulk_h:'Zaznaczanie wielu transakcji',help_tx_bulk_p:'Zaznacz pole obok transakcji, aby ją wybrać, lub użyj pola w nagłówku, aby zaznaczyć całą stronę. Jeśli wyszukiwanie lub filtr obejmuje więcej niż jedną stronę, link „Zaznacz wszystkie pasujące" pozwala zaznaczyć wszystkie wyniki naraz, a następnie usunąć je razem.',help_tx_auto_h:'Transakcje automatyczne',help_tx_auto_p:'Utwórz regułę dla wszystkiego, co się powtarza (np. czynsz lub wypłata) i wybierz częstotliwość. Aplikacja doda ją do listy automatycznie w każdym terminie. Użyj przełącznika, aby wstrzymać regułę, lub ołówka, aby ją edytować.',
    help_tx_csv_h:'Import CSV',
    ...
    // Evio (asystentka AI)
    sett_penny_h:'Evio (Asystentka budżetu AI)',
    sett_penny_desc:'Zapytaj Evio o swój budżet & nawyki wydatkowe',
    sett_penny_toggle:'Włącz Evio',
    sett_penny_hint:'Włącza asystentkę Evio i jej ikonę na pasku nawigacji.',
    ...
    sett_penny_available:'Evio jest teraz dostępna w menu nawigacji.',
    sett_penny_usage_count:'Evio odpowiedziała na {0} pytań w tym miesiącu',
    sett_penny_key_error_short:'To nie wygląda na prawidłowy klucz. Sprawdź i spróbuj ponownie.',
    confirm_penny_remove_key:'Usunąć zapisany klucz API Gemini? Evio zostanie wyłączona, dopóki nie dodasz nowego.',
    toast_penny_key_saved:'Klucz Gemini zapisany bezpiecznie.',
    penny_nav_pill_off:'Włącz Evio',
    penny_nav_pill_on:'Zapytaj Evio',
    penny_nav_aria_off:'Włącz Evio',
    penny_nav_aria_on:'Zapytaj Evio',
    penny_chat_title:'Zapytaj Evio',
    penny_input_placeholder:'Zapytaj o swój budżet…',
    penny_send:'Zapytaj',
    penny_thinking:'Evio się zastanawia…',
    ...
    penny_no_key_notice:'Dodaj swój klucz API Gemini w Ustawieniach, aby zacząć rozmowę z Evio.',
    penny_open_settings:'Otwórz ustawienia',
    penny_close:'Zamknij Evio',
    ...
    penny_err_overloaded:'Usługa Gemini firmy Google jest obecnie tymczasowo przeciążona. Spróbuj ponownie za chwilę.',
    penny_err_network:'Evio nie mogła połączyć się z serwerami Google. Sprawdź połączenie i spróbuj ponownie.',
    penny_err_blocked:'Evio nie znalazła bezpiecznej odpowiedzi na to pytanie. Spróbuj inaczej sformułować pytanie o budżet.',
    penny_err_unknown:'Coś poszło nie tak po stronie Evio. Spróbuj ponownie za chwilę.',
    ...
    help_sett_penny_p:'Włącz Evio poniżej, aby zadawać pytania o swój budżet prostym językiem. Dotknij „Jak utworzyć swój klucz”, aby zobaczyć kroki konfiguracji.',
    help_penny_title:'Konfiguracja Evio',
    help_penny_intro:'Evio to asystentka AI Evio Budget. Ponieważ ta aplikacja nie ma własnego serwera, Evio rozmawia bezpośrednio z Google z poziomu Twojej przeglądarki, korzystając z Twojego własnego, darmowego klucza API Gemini. Żadne dane nigdy nie przechodzą przez serwer Evio Budget, bo taki serwer po prostu nie istnieje.',
    ...
    help_penny_step4:'Wklej go w polu „Klucz API Gemini” w Ustawieniach Evio Budget i kliknij „Zapisz klucz”.',
    ...
    help_penny_safety_p:'Twój klucz jest szyfrowany przed zapisaniem w pamięci Twojej przeglądarki i jest wysyłany bezpośrednio do API Google tylko wtedy, gdy zadajesz Evio pytanie. Nigdy nie trafia do żadnego serwera Evio Budget.',
    ...
    guide_welcome_big:'Ultimate Budget Planner bierze prostą ideę śledzenia przychodów i wydatków i nadaje jej supermoce - prawdziwy plan spłaty długów, cele oszczędnościowe z paskami postępu, kalendarz z widokiem z lotu ptaka, śledzenie subskrypcji oraz Evio, asystentkę AI, która już zna twoje liczby. Zacznij od Pulpitu i eksploruj resztę, gdy będziesz gotowy.',
    ...
    guide_dashboard_tip:'Poświęć 30 sekund każdego ranka na przejrzenie Pulpitu - to najszybszy sposób, by zauważyć rachunek lub płatność długu, zanim się spóźni.',guide_dashboard_usecase_h:'Zobacz to w praktyce',guide_dashboard_usecase_p:'<p><strong>Maria</strong> otwiera Evio Budget w dniu wypłaty. Rzuca okiem na Pulpit i widzi, że jej saldo netto za ten okres wynosi 420 zł - wystarczająco, by dołożyć trochę więcej do funduszu awaryjnego.</p><p>Panel przepływu środków pokazuje, że przekroczyła już budżet na Restauracje, więc tego wieczoru rezygnuje z zamawiania jedzenia na wynos, zamiast dowiedzieć się o tym dopiero na koniec miesiąca.</p>',
    ...
    guide_transactions_tip:'Skonfiguruj najpierw reguły cykliczne dla swoich stałych rachunków i pensji - to największa oszczędność czasu w całej aplikacji.',guide_transactions_usecase_h:'Zobacz to w praktyce',guide_transactions_usecase_p:'<p><strong>Jack</strong> płaci kartą za odnowienie subskrypcji Netflix. Otwiera Transakcje, dotyka <strong>+ Dodaj transakcję</strong>, wybiera Wydatek → Rozrywka, wpisuje kwotę i transakcja jest zapisana w kilka sekund.</p><p>Później, robiąc porządki, zauważa kilka zduplikowanych wpisów testowych z czasu, gdy wypróbowywał aplikację. Zaznacza je za pomocą pól wyboru i dotyka <strong>Usuń zaznaczone</strong>, usuwając je wszystkie naraz zamiast pojedynczo.</p>',
    ...
    guide_budget_tip:'Przeglądaj swoje Oczekiwane kwoty raz w miesiącu - budżet, który nigdy się nie zmienia, dość szybko przestaje odzwierciedlać rzeczywistość.',guide_budget_usecase_h:'Zobacz to w praktyce',guide_budget_usecase_p:'<p>Na początku miesiąca <strong>Priya</strong> ustawia oczekiwaną kwotę na Zakupy spożywcze na 500 zł w zakładce Budżet. W miarę zapisywania transakcji w ciągu miesiąca kolumna Rzeczywiste wypełnia się automatycznie.</p><p>Pasek postępu zmienia kolor z zielonego na pomarańczowy, gdy zbliża się do limitu - ostrzegając ją, by zwolniła tempo, zanim go przekroczy, zamiast dowiedzieć się o tym później.</p>',
    ...
    guide_subscriptions_tip:'Zrób przegląd subskrypcji tuż po otrzymaniu wyciągu bankowego co miesiąc - to najłatwiejszy moment, by zauważyć coś, o czym zapomniałeś, że płacisz.',guide_subscriptions_usecase_h:'Zobacz to w praktyce',guide_subscriptions_usecase_p:'<p><strong>Jack</strong> dodaje Netflix jako subskrypcję - 65 zł, miesięcznie - i włącza <strong>Automatyzację</strong>, aby była zapisywana jako transakcja w każdym cyklu rozliczeniowym bez podnoszenia palca.</p><p>Sześć miesięcy później Netflix podnosi cenę do 75 zł. Gdy Jack następnym razem edytuje subskrypcję, aby ją zaktualizować, Evio Budget po cichu odnotowuje podwyżkę ceny i pokazuje małą strzałkę ↑ obok kwoty, dzięki czemu od razu widzi, które subskrypcje podrożały.</p>',
    ...
    guide_calendar_tip:'Sprawdzaj Kalendarz na początku każdego tygodnia - zajmuje to kilka sekund, a terminy nigdy nie są niespodzianką.',guide_calendar_usecase_h:'Zobacz to w praktyce',guide_calendar_usecase_p:'<p>Zanim wyjedzie na weekend, <strong>Amir</strong> sprawdza Kalendarz, aby zobaczyć, co jest do zapłaty w tym tygodniu. Zauważa, że rachunek za prąd jest wymagalny w poniedziałek i wciąż nieopłacony.</p><p>Płaci go online, a następnie zaznacza pole prosto w kalendarzu, wpisując faktycznie zapłacone 380 zł - zapisane bez konieczności przełączania się między zakładkami.</p>',
    ...
    guide_automation_tip:'Włącz Automatyzację, gdy twoje reguły cykliczne wydają się poprawne - jest najbardziej przydatna, gdy ufasz liczbom, które będzie zapisywać.',guide_automation_usecase_h:'Zobacz to w praktyce',guide_automation_usecase_p:'<p><strong>Tom</strong> ma trzy rzeczy, które powtarzają się co miesiąc: czynsz, ratę kredytu samochodowego i subskrypcję Netflix. Zamiast wpisywać wszystkie trzy ręcznie w każdym okresie, włącza <strong>Automatyzację</strong> dla każdej z nich.</p><p>Za każdym razem, gdy otwiera aplikację w nowym okresie, Evio Budget już zapisał je jako transakcje zgodnie z harmonogramem, a Tom musi jedynie przejrzeć to, co nowe, zamiast wpisywać ponownie to, co rutynowe.</p>',
    guide_penny_title:'Evio',
    guide_penny_big:'Evio to twoja własna asystentka AI do budżetu, wbudowana bezpośrednio w aplikację - zadaj jej pytanie o swoje pieniądze prostym językiem, a ona odczyta twoje prawdziwe dane budżetowe, aby dać ci prawdziwą odpowiedź, z wykresami, gdy to pomaga.',
    guide_penny_step1:'Otwórz <strong>Ustawienia</strong>, włącz Evio i wklej swój własny klucz API Gemini (jest tam link pokazujący dokładnie, jak zdobyć jeden za darmo).',
    ...
    guide_penny_connect1:'Evio może jedynie odczytywać twoje dane budżetowe, aby odpowiadać na pytania - nigdy nie może niczego dodać, edytować ani usunąć za ciebie.',
    ...
    guide_penny_connect3:'Twój klucz API jest szyfrowany i przechowywany wyłącznie na twoim urządzeniu - nigdy nie jest wysyłany nigdzie indziej poza bezpośrednio do Google, gdy zadajesz Evio pytanie.',
    guide_penny_tip:'Zacznij od jednego z przycisków szybkich pytań za pierwszym razem - to najszybszy sposób, by zobaczyć, co potrafi, zanim zadasz własne pytania.',guide_penny_usecase_h:'Zobacz to w praktyce',guide_penny_usecase_p:'<p>Ilekroć <strong>Diane</strong> nie jest pewna, na co poszły jej pieniądze w tym miesiącu, otwiera Evio i pyta: "dlaczego moje wydatki są wyższe niż zwykle w tym miesiącu?"</p><p>Evio analizuje jej rzeczywiste transakcje i udziela odpowiedzi w prostym języku - wskazując na przykład, że wydatki na Restauracje się podwoiły - zamiast konieczności samodzielnego przeszukiwania listy transakcji.</p>',
    ...
    guide_settings_tip:'Skonfiguruj Walutę, Okres budżetowy oraz Dane i synchronizację jako pierwsze, zanim zrobisz cokolwiek innego - to fundament, na którym zbudowana jest reszta aplikacji.',guide_settings_usecase_h:'Zobacz to w praktyce',guide_settings_usecase_p:'<p>Gdy <strong>Ben</strong> przechodzi na pracę na własny rachunek, jego dochody przestają pokrywać się z miesiącem kalendarzowym. Otwiera Ustawienia i zmienia Okres budżetowy na niestandardowy zakres dat pasujący do jego rzeczywistego cyklu wypłat.</p><p>Wybiera USD jako walutę i tymczasowo wyłącza główny przełącznik Automatyzacji, planując swój budżet od nowa.</p>',
...
function promptMarkBillPaid(billId, onDone) {
  const row = (state.budgets.bills || []).find(b => b.id === billId);
  if (!row) return;
  document.getElementById('modalTitle').textContent = `${t('bill_paid_modal_title')} - ${esc(row.category)}`;
  document.getElementById('modalBody').innerHTML = `
    <div class="field"><label class="field-label field-label--tip">${tipLabel(t('bill_paid_amount_label'), 'bill_paid_amount_hint', true)}</label>
      ...
      ${row.expected ? `<p class="field-hint">${tf('bill_paid_budgeted_hint', fmt(row.expected))}</p>` : ''}
    </div>
    <div class="tx-error" id="billPaidErr" hidden></div>
    <div class="edit-tx-actions">
      <button class="btn btn-primary" id="billPaidSaveBtn">${t('bill_paid_save_btn')}</button>
  ...
  document.getElementById('billPaidSaveBtn')?.addEventListener('click', () => {
    ...
    const tx = { id: uid(), date: today(), type: 'bill', category: row.category, amount: amt, description: '' };
    state.transactions.push(tx);
    row.paid = true; row.paidTxId = tx.id;
    saveState();
    document.getElementById('tutorialOverlay').hidden = true;
    onDone();
    showToast(t('toast_bill_marked_paid'));
  });
...
function syncBillPaidLinks() {
  ...
  (state.budgets.bills || []).forEach(b => {
    if (b.paid && b.paidTxId && !liveIds.has(b.paidTxId)) { b.paid = false; b.paidTxId = null; changed = true; }
  });
  return changed;
}
...
function renderTxList(){
  ...
  document.getElementById('clearAllBtn2')?.addEventListener('click',async()=>{if(await confirmDialog({message:t('confirm_delete_all_tx'),confirmText:t('delete')})){state.transactions=[];txSelected.clear();syncBillPaidLinks();saveState();renderTxList();}});
...
function renderCalendar(){
  ...
  for(const b of state.budgets.bills||[])if(b.dueDate){const d=parseInt(b.dueDate.split('-')[2]);if(d>=1&&d<=daysInMo){
    const paidTx=b.paid&&b.paidTxId?state.transactions.find(tx=>tx.id===b.paidTxId):null;
    addEv(d,{type:'bill',id:b.id,label:b.category,amount:paidTx?paidTx.amount:(b.expected||0),color:'#fb923c',paid:b.paid});
  }}
...
function renderSettings(){
  ...
  document.getElementById('settAutomation')?.addEventListener('change', e => {
    ...
    saveState();
    if (e.target.checked) { trackEvent('feature_used', { feature: 'automation_enabled' }); const g = processRecurring(); if (g > 0) setTimeout(() => showToast(tf('recurring_generated', g)), 300); else showToast(t('toast_saved')); }
...
async function init(){
  ...
  try {
    ...
    // Evio (AI assistant) - failure here must never block the rest of init
    try { await pennyInit(); } catch (e) { console.error('[init] Evio setup failed:', e); }
