...
const TRANSLATIONS = {
  en: {
    ...
    help_cal_paid_h:'Marking bills paid',help_cal_paid_p:'Click a day to expand its events. Any unpaid bill shows a "Mark paid" checkbox right there - no need to switch to the Budget tab.',help_cal_tip:'\uD83D\uDCA1 Set due dates on bills and debts to get the most out of the calendar.',
    sf_add_btn:'+ Add fund',
  ...
  de: {
    ...
    help_cal_paid_h:'Rechnungen als bezahlt markieren',help_cal_paid_p:'Klicke auf einen Tag, um seine Ereignisse aufzuklappen. Jede unbezahlte Rechnung zeigt dort direkt ein Kästchen „Als bezahlt markieren" - ohne zum Tab Budget wechseln zu müssen.',help_cal_tip:'💡 Setze Fälligkeitsdaten für Rechnungen und Schulden, um den Kalender optimal zu nutzen.',
  ...
  fr: {
    ...
    help_cal_paid_h:'Marquer les factures comme payées',help_cal_paid_p:'Cliquez sur un jour pour développer ses événements. Toute facture impayée y affiche directement une case « Marquer comme payé » - inutile de passer par l’onglet Budget.',help_cal_tip:"💡 Définissez des dates d'échéance sur les factures et dettes pour profiter au maximum du calendrier.",
  ...
  es: {
    ...
    help_cal_paid_h:'Marcar facturas como pagadas',help_cal_paid_p:'Haz clic en un día para desplegar sus eventos. Cualquier factura sin pagar muestra ahí mismo una casilla «Marcar como pagado» - sin necesidad de ir a la pestaña Presupuesto.',help_cal_tip:'💡 Establece fechas de vencimiento en facturas y deudas para aprovechar al máximo el calendario.',
  ...
  pl: {
    ...
    help_cal_paid_h:'Oznaczanie rachunków jako zapłaconych',help_cal_paid_p:'Kliknij dzień, aby rozwinąć jego zdarzenia. Każdy niezapłacony rachunek pokazuje tam pole „Oznacz jako zapłacone" - bez konieczności przechodzenia do zakładki Budżet.',help_cal_tip:'💡 Ustaw daty płatności dla rachunków i długów, aby w pełni wykorzystać możliwości kalendarza.',
