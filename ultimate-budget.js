...
function defaultState() {
  ...
  return {
    settings: { currency:'USD', symbol:'$', periodStart:start, periodEnd:end, language:'en', automationEnabled:true, pennyEnabled:false, upcomingDays:7, dashboardLayout:SLEEK_LAYOUT, dashboardAnimations:true, onboardingDone:false },
    rollover: 0,
    budgets: {
...
const TRANSLATIONS = {
  ...
  de: {
    ...
    dpc_focus_word:'Fokus',
    dpc_focus_seq:'Zusätzliches Geld geht zuerst hierhin: {0}',
    dpc_focus_none:'Lege oben eine zusätzliche monatliche Zahlung fest, dann entscheidet diese Reihenfolge, welche Schuld zuerst getilgt wird.',
    dpc_focus_hint:'Wohin dein zusätzliches Geld fließt, in der Reihenfolge',
    ...
    tx_way_auto_none:'Noch nichts Wiederkehrendes',
    tx_way_auto_one:'1 Regel aktiv',
    tx_way_auto_many:'{0} Regeln aktiv',
    tx_way_view:'Alle ansehen',
    tx_way_close:'Schließen',
    ...
    // Ezzo (KI-Assistentin)
    sett_penny_h:'Ezzo (KI-Budget-Assistentin)',
    sett_penny_desc:'Stelle Ezzo Fragen zu deinem Budget & deinen Ausgabengewohnheiten',
    sett_penny_toggle:'Ezzo aktivieren',
    sett_penny_hint:'Schaltet die Assistentin Ezzo und ihr Symbol in der Navigationsleiste ein.',
    ...
    sett_penny_available:'Ezzo ist jetzt im Navigationsmenü verfügbar.',
    sett_penny_usage_count:'Ezzo hat diesen Monat {0} Fragen beantwortet',
    sett_penny_key_error_short:'Das sieht nicht wie ein gültiger Schlüssel aus. Bitte überprüfen und erneut versuchen.',
    confirm_penny_remove_key:'Deinen gespeicherten Gemini API-Schlüssel entfernen? Ezzo wird deaktiviert, bis du einen neuen hinzufügst.',
    toast_penny_key_saved:'Gemini-Schlüssel sicher gespeichert.',
    penny_nav_pill_off:'Ezzo aktivieren',
    penny_nav_pill_on:'Ezzo fragen',
    penny_nav_aria_off:'Ezzo aktivieren',
    penny_nav_aria_on:'Ezzo fragen',
    penny_chat_title:'Ezzo fragen',
    penny_input_placeholder:'Frage zu deinem Budget…',
    penny_send:'Fragen',
    penny_thinking:'Ezzo überlegt…',
    ...
    penny_no_key_notice:'Füge deinen Gemini API-Schlüssel in den Einstellungen hinzu, um mit Ezzo zu chatten.',
    penny_open_settings:'Einstellungen öffnen',
    penny_close:'Ezzo schließen',
    ...
    penny_err_network:'Ezzo konnte die Server von Google nicht erreichen. Überprüfe deine Verbindung und versuche es erneut.',
    penny_err_blocked:'Ezzo konnte darauf keine sichere Antwort finden. Versuche, deine Frage zum Budget anders zu formulieren.',
    penny_err_unknown:'Bei Ezzo ist etwas schiefgelaufen. Bitte versuche es gleich noch einmal.',
    ...
    help_sett_penny_p:'Schalte Ezzo unten ein, um Fragen zu deinem Budget in einfacher Sprache zu stellen. Tippe auf „So erstelle ich meinen Schlüssel“ für die Einrichtungsschritte.',
    help_penny_title:'Ezzo einrichten',
    help_penny_intro:'Ezzo ist der KI-Assistent von Ezzo Budget. Da diese App keinen eigenen Server hat, spricht Ezzo direkt von deinem Browser aus mit Google, über deinen eigenen kostenlosen Gemini API-Schlüssel. Es läuft nie über einen Ezzo-Budget-Server, denn den gibt es nicht.',
    ...
    help_penny_step4:'Füge ihn in das Feld „Gemini API-Schlüssel“ in den Einstellungen von Ezzo Budget ein und klicke auf „Schlüssel speichern“.',
    ...
    help_penny_safety_p:'Dein Schlüssel wird verschlüsselt, bevor er im Speicher deines eigenen Browsers gespeichert wird, und wird nur direkt an die API von Google gesendet, wenn du Ezzo eine Frage stellst. Er geht niemals an einen Server von Ezzo Budget.',
    ...
    guide_welcome_big:'Ultimate Budget Planner nimmt die einfache Idee, Einnahmen und Ausgaben zu verfolgen, und verleiht ihr Superkräfte - einen echten Tilgungsplan für Schulden, Sparziele mit Fortschrittsbalken, einen Kalender mit Rundumblick, eine Abo-Übersicht und Ezzo, eine KI-Assistentin, die deine Zahlen schon kennt. Starte mit dem Dashboard und erkunde den Rest, wann immer du bereit bist.',
    guide_dashboard_title:'Dashboard',
  ...
  fr: {
    ...
    dpc_focus_word:'Priorité',
    dpc_focus_seq:'L\'argent supplémentaire va d\'abord ici : {0}',
    dpc_focus_none:'Définissez un paiement mensuel supplémentaire ci-dessus et cet ordre décide quelle dette est soldée en premier.',
    dpc_focus_hint:'Où va votre argent supplémentaire, dans l\'ordre',
    ...
    tx_way_auto_none:'Rien de récurrent pour le moment',
    tx_way_auto_one:'1 règle active',
    tx_way_auto_many:'{0} règles actives',
    tx_way_view:'Tout voir',
    tx_way_close:'Fermer',
    ...
    // Ezzo (assistante IA)
    sett_penny_h:'Ezzo (Assistante budgétaire IA)',
    sett_penny_desc:'Posez des questions à Ezzo sur votre budget & vos habitudes de dépenses',
    sett_penny_toggle:'Activer Ezzo',
    sett_penny_hint:'Active l’assistante Ezzo et son icône dans la barre de navigation.',
    ...
    sett_penny_available:'Ezzo est maintenant disponible dans le menu de navigation.',
    sett_penny_usage_count:'Ezzo a répondu à {0} questions ce mois-ci',
    sett_penny_key_error_short:'Cela ne ressemble pas à une clé valide. Vérifiez et réessayez.',
    confirm_penny_remove_key:'Supprimer votre clé API Gemini enregistrée ? Ezzo sera désactivée jusqu’à ce que vous en ajoutiez une nouvelle.',
    toast_penny_key_saved:'Clé Gemini enregistrée en toute sécurité.',
    penny_nav_pill_off:'Activer Ezzo',
    penny_nav_pill_on:'Demander à Ezzo',
    penny_nav_aria_off:'Activer Ezzo',
    penny_nav_aria_on:'Demander à Ezzo',
    penny_chat_title:'Demander à Ezzo',
    penny_input_placeholder:'Posez une question sur votre budget…',
    penny_send:'Demander',
    penny_thinking:'Ezzo réfléchit…',
    ...
    penny_no_key_notice:'Ajoutez votre clé API Gemini dans les Paramètres pour commencer à discuter avec Ezzo.',
    penny_open_settings:'Ouvrir les paramètres',
    penny_close:'Fermer Ezzo',
    ...
    penny_err_network:'Ezzo n’a pas pu joindre les serveurs de Google. Vérifiez votre connexion et réessayez.',
    penny_err_blocked:'Ezzo n’a pas trouvé de réponse sûre à cela. Essayez de reformuler votre question sur votre budget.',
    penny_err_unknown:'Une erreur s’est produite du côté de Ezzo. Veuillez réessayer dans un instant.',
    ...
    help_sett_penny_p:'Activez Ezzo ci-dessous pour poser des questions sur votre budget en langage simple. Touchez « Comment créer ma clé » pour les étapes de configuration.',
    help_penny_title:'Configurer Ezzo',
    help_penny_intro:'Ezzo est l’assistante IA d’Ezzo Budget. Comme cette application n’a pas de serveur, Ezzo parle directement depuis votre navigateur à Google grâce à votre propre clé API Gemini gratuite. Rien ne transite jamais par un serveur Ezzo Budget, puisqu’il n’y en a pas.',
    ...
    help_penny_step4:'Collez-la dans le champ « Clé API Gemini » des Paramètres d’Ezzo Budget et cliquez sur « Enregistrer la clé ».',
    ...
    help_penny_safety_p:'Votre clé est chiffrée avant d’être enregistrée dans le stockage de votre propre navigateur, et elle n’est envoyée directement à l’API de Google que lorsque vous posez une question à Ezzo. Elle ne va jamais à un serveur d’Ezzo Budget.',
    ...
    guide_dashboard_tip:"Prenez 30 secondes chaque matin pour parcourir le tableau de bord - c'est le moyen le plus rapide de repérer une facture ou un paiement de dette avant qu'il ne soit en retard.",guide_dashboard_usecase_h:'Un exemple concret',guide_dashboard_usecase_p:"<p><strong>Maria</strong> ouvre Ezzo Budget le jour de paie. Elle jette un œil au tableau de bord et voit que son solde net pour cette période est de 420 € - assez pour ajouter un peu plus à son fonds d'urgence.</p><p>Le panneau de flux de trésorerie montre qu'elle dépasse déjà son budget Restaurants, alors elle renonce à commander à emporter ce soir-là au lieu de le découvrir à la fin du mois.</p>",
    guide_transactions_title:'Transactions',
    ...
    guide_sinking_tip:"Découpez les grands objectifs en montants mensuels ronds - il est bien plus facile de s'engager à 50 € par mois que de « économiser pour des vacances un jour ».",guide_sinking_usecase_h:'Un exemple concret',guide_sinking_usecase_p:"<p><strong>Elena</strong> prépare des vacances à 1 200 € pour juillet prochain. Elle crée une Réserve avec ce montant cible et cette date, et Ezzo Budget lui indique qu'elle doit épargner 150 €/mois pour y arriver.</p><p>Elle active <strong>Automatiser</strong> pour que ce montant soit enregistré comme contribution chaque mois sans qu'elle ait besoin d'y penser.</p>",
    ...
    guide_automation_tip:"Activez l'Automatisation une fois que vos règles récurrentes vous semblent justes - elle est surtout utile une fois que vous faites confiance aux chiffres qu'elle va saisir.",guide_automation_usecase_h:'Un exemple concret',guide_automation_usecase_p:"<p><strong>Tom</strong> a trois choses qui reviennent chaque mois : le loyer, sa mensualité de prêt auto et un abonnement Netflix. Plutôt que de les saisir à la main chaque période, il active <strong>Automatiser</strong> pour chacune.</p><p>Chaque fois qu'il ouvre l'application sur une nouvelle période, Ezzo Budget les a déjà enregistrées comme transactions selon le calendrier prévu, et Tom n'a plus qu'à vérifier ce qui est nouveau au lieu de ressaisir ce qui est routinier.</p>",
    guide_penny_title:'Ezzo',
    guide_penny_big:"Ezzo est votre propre assistante IA pour le budget, intégrée directement à l'application - posez-lui une question sur votre argent en langage courant, et elle lit vos vraies données budgétaires pour vous donner une vraie réponse, avec des graphiques quand c'est utile.",
    guide_penny_step1:"Ouvrez les <strong>Paramètres</strong>, activez Ezzo, et collez votre propre clé API Gemini (un lien est juste là pour montrer exactement comment en obtenir une gratuitement).",
    ...
    guide_penny_connect1:"Ezzo ne peut que lire vos données budgétaires pour répondre aux questions - elle ne peut jamais rien ajouter, modifier ou supprimer pour vous.",
    ...
    guide_penny_connect3:"Votre clé API est chiffrée et stockée uniquement sur votre propre appareil - elle n'est jamais envoyée nulle part, sauf directement à Google quand vous posez une question à Ezzo.",
    guide_penny_tip:"Commencez par l'un des boutons de question rapide la première fois - c'est le moyen le plus rapide de voir ce qu'elle sait faire avant de poser vos propres questions.",guide_penny_usecase_h:'Un exemple concret',guide_penny_usecase_p:'<p>Chaque fois que <strong>Diane</strong> ne sait plus où est passé son argent ce mois-ci, elle ouvre Ezzo et demande « pourquoi mes dépenses sont-elles plus élevées que d\'habitude ce mois-ci ? »</p><p>Ezzo examine ses transactions réelles et lui donne une réponse en langage simple - en signalant, par exemple, que ses dépenses en Restaurants ont doublé - au lieu qu\'elle doive fouiller elle-même dans la liste des transactions.</p>',
  ...
  es: {
    ...
    dpc_focus_word:'Prioridad',
    dpc_focus_seq:'El dinero extra va primero aquí: {0}',
    dpc_focus_none:'Define un pago mensual extra arriba y este orden decide qué deuda se liquida primero.',
    dpc_focus_hint:'Adónde va tu dinero extra, en orden',
    ...
    tx_way_auto_none:'Todavía nada recurrente',
    tx_way_auto_one:'1 regla activa',
    tx_way_auto_many:'{0} reglas activas',
    tx_way_view:'Ver todas',
    tx_way_close:'Cerrar',
    ...
    // Ezzo (asistente IA)
    sett_penny_h:'Ezzo (Asistente de presupuesto con IA)',
    sett_penny_desc:'Pregúntale a Ezzo sobre tu presupuesto & tus hábitos de gasto',
    sett_penny_toggle:'Activar Ezzo',
    sett_penny_hint:'Activa la asistente Ezzo y su icono en la barra de navegación.',
    ...
    sett_penny_available:'Ezzo ya está disponible en el menú de navegación.',
    sett_penny_usage_count:'Ezzo ha respondido {0} preguntas este mes',
    sett_penny_key_error_short:'Eso no parece una clave válida. Revísala e inténtalo de nuevo.',
    confirm_penny_remove_key:'¿Eliminar tu clave de API de Gemini guardada? Ezzo se desactivará hasta que agregues una nueva.',
    toast_penny_key_saved:'Clave de Gemini guardada de forma segura.',
    penny_nav_pill_off:'Activar Ezzo',
    penny_nav_pill_on:'Preguntar a Ezzo',
    penny_nav_aria_off:'Activar Ezzo',
    penny_nav_aria_on:'Preguntar a Ezzo',
    penny_chat_title:'Preguntar a Ezzo',
    penny_input_placeholder:'Pregunta sobre tu presupuesto…',
    penny_send:'Preguntar',
    penny_thinking:'Ezzo está pensando…',
    ...
    penny_no_key_notice:'Añade tu clave de API de Gemini en Ajustes para empezar a chatear con Ezzo.',
    penny_open_settings:'Abrir ajustes',
    penny_close:'Cerrar Ezzo',
    ...
    penny_err_network:'Ezzo no pudo conectarse con los servidores de Google. Revisa tu conexión e inténtalo de nuevo.',
    penny_err_blocked:'Ezzo no pudo dar una respuesta segura a eso. Intenta reformular tu pregunta sobre tu presupuesto.',
    penny_err_unknown:'Algo salió mal del lado de Ezzo. Inténtalo de nuevo en un momento.',
    penny_err_key_unreadable:'No se pudo leer tu clave guardada. Vuelve a introducirla en Ajustes.',
    penny_err_retry:'Reintentar',
    help_sett_penny_p:'Activa Ezzo abajo para hacer preguntas sobre tu presupuesto en lenguaje sencillo. Toca «Cómo crear mi clave» para ver los pasos de configuración.',
    help_penny_title:'Configurar a Ezzo',
    help_penny_intro:'Ezzo es la asistente de IA de Ezzo Budget. Como esta app no tiene servidor propio, Ezzo habla directamente desde tu navegador con Google usando tu propia clave de API de Gemini gratuita. Nada pasa nunca por un servidor de Ezzo Budget, porque no existe ninguno.',
    ...
    help_penny_step4:'Pégala en el campo «Clave de API de Gemini» en los Ajustes de Ezzo Budget y haz clic en «Guardar clave».',
    ...
    help_penny_safety_p:'Tu clave se cifra antes de guardarse en el almacenamiento de tu propio navegador, y solo se envía directamente a la API de Google cuando le haces una pregunta a Ezzo. Nunca se envía a un servidor de Ezzo Budget.',
    ...
    guide_automation_tip:'Activa la Automatización una vez que tus reglas recurrentes te parezcan correctas - es más útil cuando confías en los números que va a registrar.',guide_automation_usecase_h:'Así se usa en la práctica',guide_automation_usecase_p:'<p><strong>Tom</strong> tiene tres cosas que se repiten cada mes: el alquiler, la cuota de su préstamo de coche y una suscripción a Netflix. En lugar de escribir las tres a mano cada período, activa <strong>Automatizar</strong> en cada una.</p><p>Cada vez que abre la app en un nuevo período, Ezzo Budget ya las ha registrado como transacciones según lo previsto, y Tom solo necesita revisar lo nuevo en lugar de volver a introducir lo rutinario.</p>',
    guide_penny_title:'Ezzo',
    guide_penny_big:'Ezzo es tu propia asistente de IA para el presupuesto, integrada directamente en la app - hazle una pregunta sobre tu dinero en lenguaje sencillo, y ella lee tus datos reales de presupuesto para darte una respuesta real, con gráficos cuando ayuda.',
    guide_penny_step1:'Abre <strong>Ajustes</strong>, activa Ezzo, y pega tu propia clave de API de Gemini (hay un enlace justo ahí que muestra exactamente cómo conseguir una gratis).',
  ...
  it: {
    ...
    dpc_focus_word:'Priorità',
    dpc_focus_seq:'Il denaro extra va prima qui: {0}',
    dpc_focus_none:'Imposta un pagamento mensile extra sopra e questo ordine decide quale debito viene estinto per primo.',
    dpc_focus_hint:'Dove va il tuo denaro extra, in ordine',
    ...
    tx_way_auto_none:'Ancora nulla di ricorrente',
    tx_way_auto_one:'1 regola attiva',
    tx_way_auto_many:'{0} regole attive',
    tx_way_view:'Vedi tutte',
    tx_way_close:'Chiudi',
    ...
    confirm_remove_cat:'Rimuovere questa categoria?',bud_edit_title:'\u270f\ufe0f Modifica categoria',bud_name_required:'Assegna un nome alla categoria.',bud_name_taken:'Un\u2019altra categoria di questa sezione usa gi\u00e0 questo nome.',bud_expected_invalid:'Inserisci un importo previsto pari o superiore a 0.',confirm_delete_all_tx:'Eliminare TUTTE le transazioni? Questa azione \u00e8 irreversibile.',
    ...
    // Ezzo (assistente IA)
    sett_penny_h:'Ezzo (Assistente di budget IA)',
    sett_penny_desc:'Chiedi a Ezzo del tuo budget & delle tue abitudini di spesa',
    sett_penny_toggle:'Attiva Ezzo',
    sett_penny_hint:'Attiva l’assistente Ezzo e la sua icona nella barra di navigazione.',
    ...
    sett_penny_available:'Ezzo è ora disponibile nel menu di navigazione.',
    sett_penny_usage_count:'Ezzo ha risposto a {0} domande questo mese',
    sett_penny_key_error_short:'Non sembra una chiave valida. Controlla e riprova.',
    confirm_penny_remove_key:'Rimuovere la chiave API Gemini salvata? Ezzo verrà disattivata finché non ne aggiungi una nuova.',
    toast_penny_key_saved:'Chiave Gemini salvata in modo sicuro.',
    penny_nav_pill_off:'Attiva Ezzo',
    penny_nav_pill_on:'Chiedi a Ezzo',
    penny_nav_aria_off:'Attiva Ezzo',
    penny_nav_aria_on:'Chiedi a Ezzo',
    penny_chat_title:'Chiedi a Ezzo',
    penny_input_placeholder:'Fai una domanda sul tuo budget…',
    penny_send:'Chiedi',
    penny_thinking:'Ezzo sta pensando…',
    ...
    penny_no_key_notice:'Aggiungi la tua chiave API Gemini nelle Impostazioni per iniziare a chattare con Ezzo.',
    penny_open_settings:'Apri Impostazioni',
    penny_close:'Chiudi Ezzo',
    ...
    penny_err_network:'Ezzo non è riuscita a raggiungere i server di Google. Controlla la connessione e riprova.',
    penny_err_blocked:'Ezzo non è riuscita a trovare una risposta sicura. Prova a riformulare la tua domanda sul budget.',
    penny_err_unknown:'Qualcosa è andato storto dal lato di Ezzo. Riprova tra un momento.',
    ...
    help_sett_penny_p:'Attiva Ezzo qui sotto per fare domande sul tuo budget in linguaggio semplice. Tocca «Come creare la mia chiave» per i passaggi di configurazione.',
    help_penny_title:'Configurare Ezzo',
    help_penny_intro:'Ezzo è l’assistente IA di Ezzo Budget. Poiché questa app non ha un proprio server, Ezzo parla direttamente dal tuo browser con Google usando la tua chiave API Gemini gratuita. Nulla passa mai da un server di Ezzo Budget, perché non ne esiste uno.',
    ...
    help_penny_step4:'Incollala nel campo «Chiave API Gemini» nelle Impostazioni di Ezzo Budget e fai clic su «Salva chiave».',
    ...
    help_penny_safety_p:'La tua chiave viene crittografata prima di essere salvata nell’archivio del tuo browser, e viene inviata direttamente all’API di Google solo quando fai una domanda a Ezzo. Non viene mai inviata a un server di Ezzo Budget.',
    ...
    guide_welcome_big:"Ultimate Budget Planner prende l'idea semplice di tracciare entrate e uscite e le dà superpoteri - un vero piano di rimborso debiti, obiettivi di risparmio con barre di progresso, un calendario con vista d'insieme, tracciamento degli abbonamenti e Ezzo, un'assistente IA che conosce già i tuoi numeri. Inizia dalla Dashboard ed esplora il resto quando sei pronto.",
    guide_dashboard_title:"Dashboard",
    ...
    guide_automation_tip:"Attiva l'Automazione una volta che le tue regole ricorrenti ti sembrano corrette - è più utile quando ti fidi dei numeri che registrerà.",guide_automation_usecase_h:'Un esempio pratico',guide_automation_usecase_p:"<p><strong>Tom</strong> ha tre cose che si ripetono ogni mese: l'affitto, la rata del prestito auto e un abbonamento Netflix. Invece di inserirle tutte e tre a mano ogni periodo, attiva <strong>Automatizza</strong> per ciascuna.</p><p>Ogni volta che apre l'app in un nuovo periodo, Ezzo Budget le ha già registrate come transazioni secondo il programma, e Tom deve solo controllare cosa c'è di nuovo invece di reinserire ciò che è di routine.</p>",
    guide_penny_title:"Ezzo",
    guide_penny_big:"Ezzo è la tua assistente IA personale per il budget, integrata direttamente nell'app - fai una domanda sul tuo denaro in linguaggio semplice, e lei legge i tuoi dati di budget reali per darti una risposta reale, con grafici quando è utile.",
    guide_penny_step1:"Apri le <strong>Impostazioni</strong>, attiva Ezzo, e incolla la tua chiave API Gemini personale (c'è un link proprio lì che mostra esattamente come ottenerne una gratis).",
    ...
    sample_loaded_toast:'Dati di esempio caricati',
  ...
  pl: {
    ...
    dpc_focus_word:'Priorytet',
    dpc_focus_seq:'Dodatkowe pieniądze idą najpierw tutaj: {0}',
    dpc_focus_none:'Ustaw powyżej dodatkową miesięczną wpłatę, a ta kolejność zdecyduje, który dług zostanie spłacony pierwszy.',
    dpc_focus_hint:'Gdzie trafiają Twoje dodatkowe pieniądze, w kolejności',
    ...
    tx_way_auto_none:'Jeszcze nic się nie powtarza',
    tx_way_auto_one:'1 aktywna reguła',
    tx_way_auto_many:'Aktywne reguły: {0}',
    tx_way_view:'Zobacz wszystkie',
    tx_way_close:'Zamknij',
    ...
    dash_net_leftover:'Saldo netto okresu',nl_breakdown:'Zestawienie',nl_spent_today:'Wydano dziś',nl_upcoming_title:'Nadchodzące płatności',nl_show:'Pokaż',nl_hide:'Ukryj',nl_partial_of:'Zapłacono {0} z {1}',mod_mark_paid:'Oznacz jako opłacone',pay_btn:'Zapłać',paid_partial:'Częściowo',pay_partial_hint:'Pozostanie {0} do zapłaty. {1} pozostaje otwarte.',pay_already_hint:'Zapłacono już {0} z {1} zaplanowanych.',pay_save_partial:'Zapisz część płatności',pay_logged_title:'Zapisane płatności',pay_remove_aria:'Usuń tę płatność',toast_payment_removed:'Płatność usunięta',nl_still_to_pay:'Do zap\u0142aty',nl_free_to_spend:'Wolne \u015brodki',nl_due_before:'przed {0}',nl_nothing_due:'Nic wi\u0119cej do zap\u0142aty w tym okresie',nl_free_rate:'{0} dziennie przez {1} dni',nl_income_kept:'Zatrzymany doch\u00f3d',nl_day_of:'Dzień {0} z {1} w tym okresie',nl_per_day:'To {0} dziennie przez pozostałe {1} dni.',nl_over_by:'Przekroczono o {0} w tym okresie, zostało {1} dni.',nl_empty:'Dodaj przychody i oczekiwane kwoty, aby zobaczyć, co zostaje.',nl_total:'Saldo netto',
    ...
    confirm_remove_cat:'Usun\u0105\u0107 t\u0119 kategori\u0119?',bud_edit_title:'\u270f\ufe0f Edytuj kategori\u0119',bud_name_required:'Nadaj kategorii nazw\u0119.',bud_name_taken:'Inna kategoria w tej sekcji ju\u017c u\u017cywa tej nazwy.',bud_expected_invalid:'Podaj oczekiwan\u0105 kwot\u0119 0 lub wi\u0119cej.',confirm_delete_all_tx:'Usun\u0105\u0107 WSZYSTKIE transakcje? Tej operacji nie mo\u017cna cofn\u0105\u0107.',
    ...
    // Ezzo (asystentka AI)
    sett_penny_h:'Ezzo (Asystentka budżetu AI)',
    sett_penny_desc:'Zapytaj Ezzo o swój budżet & nawyki wydatkowe',
    sett_penny_toggle:'Włącz Ezzo',
    sett_penny_hint:'Włącza asystentkę Ezzo i jej ikonę na pasku nawigacji.',
    ...
    sett_penny_available:'Ezzo jest teraz dostępna w menu nawigacji.',
    sett_penny_usage_count:'Ezzo odpowiedziała na {0} pytań w tym miesiącu',
    sett_penny_key_error_short:'To nie wygląda na prawidłowy klucz. Sprawdź i spróbuj ponownie.',
    confirm_penny_remove_key:'Usunąć zapisany klucz API Gemini? Ezzo zostanie wyłączona, dopóki nie dodasz nowego.',
    toast_penny_key_saved:'Klucz Gemini zapisany bezpiecznie.',
    penny_nav_pill_off:'Włącz Ezzo',
    penny_nav_pill_on:'Zapytaj Ezzo',
    penny_nav_aria_off:'Włącz Ezzo',
    penny_nav_aria_on:'Zapytaj Ezzo',
    penny_chat_title:'Zapytaj Ezzo',
    penny_input_placeholder:'Zapytaj o swój budżet…',
    penny_send:'Zapytaj',
    penny_thinking:'Ezzo się zastanawia…',
    ...
    penny_no_key_notice:'Dodaj swój klucz API Gemini w Ustawieniach, aby zacząć rozmowę z Ezzo.',
    penny_open_settings:'Otwórz ustawienia',
    penny_close:'Zamknij Ezzo',
    ...
    penny_err_network:'Ezzo nie mogła połączyć się z serwerami Google. Sprawdź połączenie i spróbuj ponownie.',
    penny_err_blocked:'Ezzo nie znalazła bezpiecznej odpowiedzi na to pytanie. Spróbuj inaczej sformułować pytanie o budżet.',
    penny_err_unknown:'Coś poszło nie tak po stronie Ezzo. Spróbuj ponownie za chwilę.',
    ...
    help_sett_penny_p:'Włącz Ezzo poniżej, aby zadawać pytania o swój budżet prostym językiem. Dotknij „Jak utworzyć swój klucz”, aby zobaczyć kroki konfiguracji.',
    help_penny_title:'Konfiguracja Ezzo',
    help_penny_intro:'Ezzo to asystentka AI Ezzo Budget. Ponieważ ta aplikacja nie ma własnego serwera, Ezzo rozmawia bezpośrednio z Google z poziomu Twojej przeglądarki, korzystając z Twojego własnego, darmowego klucza API Gemini. Żadne dane nigdy nie przechodzą przez serwer Ezzo Budget, bo taki serwer po prostu nie istnieje.',
    ...
    help_penny_step4:'Wklej go w polu „Klucz API Gemini” w Ustawieniach Ezzo Budget i kliknij „Zapisz klucz”.',
    ...
    help_penny_safety_p:'Twój klucz jest szyfrowany przed zapisaniem w pamięci Twojej przeglądarki i jest wysyłany bezpośrednio do API Google tylko wtedy, gdy zadajesz Ezzo pytanie. Nigdy nie trafia do żadnego serwera Ezzo Budget.',
    ...
    guide_welcome_big:'Ultimate Budget Planner bierze prostą ideę śledzenia przychodów i wydatków i nadaje jej supermoce - prawdziwy plan spłaty długów, cele oszczędnościowe z paskami postępu, kalendarz z widokiem z lotu ptaka, śledzenie subskrypcji oraz Ezzo, asystentkę AI, która już zna twoje liczby. Zacznij od Pulpitu i eksploruj resztę, gdy będziesz gotowy.',
    ...
    guide_automation_tip:'Włącz Automatyzację, gdy twoje reguły cykliczne wydają się poprawne - jest najbardziej przydatna, gdy ufasz liczbom, które będzie zapisywać.',guide_automation_usecase_h:'Zobacz to w praktyce',guide_automation_usecase_p:'<p><strong>Tom</strong> ma trzy rzeczy, które powtarzają się co miesiąc: czynsz, ratę kredytu samochodowego i subskrypcję Netflix. Zamiast wpisywać wszystkie trzy ręcznie w każdym okresie, włącza <strong>Automatyzację</strong> dla każdej z nich.</p><p>Za każdym razem, gdy otwiera aplikację w nowym okresie, Ezzo Budget już zapisał je jako transakcje zgodnie z harmonogramem, a Tom musi jedynie przejrzeć to, co nowe, zamiast wpisywać ponownie to, co rutynowe.</p>',
    guide_penny_title:'Ezzo',
    guide_penny_big:'Ezzo to twoja własna asystentka AI do budżetu, wbudowana bezpośrednio w aplikację - zadaj jej pytanie o swoje pieniądze prostym językiem, a ona odczyta twoje prawdziwe dane budżetowe, aby dać ci prawdziwą odpowiedź, z wykresami, gdy to pomaga.',
    guide_penny_step1:'Otwórz <strong>Ustawienia</strong>, włącz Ezzo i wklej swój własny klucz API Gemini (jest tam link pokazujący dokładnie, jak zdobyć jeden za darmo).',
    ...
    sample_loaded_toast:'Wczytano przykładowe dane',
...
function openEditBudgetRow(type, id) {
  ...
  document.getElementById('modalBody').innerHTML = `
    ...
    ${meta.hasDates ? `<div class="field"><label class="field-label">${t('bud_th_due_date')}</label>
      ${styledDateField('ebDate', 'ebDateWrap', row.dueDate || '')}</div>` : ''}
  ...
  document.getElementById('tutorialOverlay').hidden = false;
  if (meta.hasDates) bindDateField('ebDate', 'ebDateWrap');
  ...
  document.getElementById('ebSave')?.addEventListener('click', () => {
    ...
    if (name !== oldName) {
      ...
      (state.recurringTemplates || []).forEach(r => { if (r.type === txType && r.category === oldName) r.category = name; });
    }
    row.category = name;
    row.expected = exp;
...
function openAddBudgetRow(type) {
  ...
  document.getElementById('modalBody').innerHTML = `
    ...
    ${meta.hasDates ? `<div class="field"><label class="field-label field-label--tip">${tipLabel(t('bud_due_date_label'),'bud_due_date_hint',false)}</label>
      ${styledDateField('abDate', 'abDateWrap', '')}</div>` : ''}
  ...
  document.getElementById('tutorialOverlay').hidden = false;
  if (meta.hasDates) bindDateField('abDate', 'abDateWrap');
  ...
  el.innerHTML=`${bulkBar}
    ${count===0&&total===0
      ...
      :`<div class="tx-table-wrap"><table class="tx-table"><thead><tr>
          ...
          <th>${t('tx_th_amount')}</th><th class="col-sm-hide">${t('tx_th_desc')}</th><th class="col-sm-hide"></th><th></th>
        </tr></thead><tbody>
...
// One row per rule, and the listeners that go with them. Both live here
// because the list is built in a modal now and rebuilt whenever a rule is
// toggled, edited or removed.
function recurringRowsHtml(){
  return (state.recurringTemplates||[]).map(tmpl=>`<div class="recurring-row" data-rid="${tmpl.id}">
    <span class="tx-pill tx-pill--${tmpl.type}" style="font-size:10px">${esc(txTypeLabel(tmpl.type))}</span>
    <span class="recurring-row-label">${esc(tmpl.label||tmpl.category)}${tmpl.sourceType?`<span class="rec-source-badge" title="${t('automate_linked')}">${({subscription:'\u{1F504}',sinking_fund:'\u{1F3FA}',debt:'\u{1F4B3}'})[tmpl.sourceType]||'\u{1F517}'}</span>`:''}</span>
    ...
    <span class="recurring-actions">
      ...
      <button class="edit-btn rec-edit-btn" data-rid="${tmpl.id}" type="button" title="${t('edit')}" aria-label="${t('edit')}">\u270f\ufe0f</button>
      <button class="del-btn rec-del-btn" data-rid="${tmpl.id}" type="button" title="${t('recurring_remove')}" aria-label="${t('recurring_remove')}">\u00d7</button>
    </span>
  </div>`).join('');
}
function bindRecurringRows(scope){
  scope.querySelectorAll('.rec-edit-btn[data-rid]').forEach(b=>b.addEventListener('click',()=>{
  ...
  scope.querySelectorAll('.rec-del-btn[data-rid]').forEach(b=>b.addEventListener('click',()=>{
    state.recurringTemplates=(state.recurringTemplates||[]).filter(r=>r.id!==b.dataset.rid);
    saveState();renderTransactions();openRecurringList();
  }));
  scope.querySelectorAll('.rec-toggle-cb[data-rid]').forEach(cb=>cb.addEventListener('change',()=>{
    const r=(state.recurringTemplates||[]).find(r=>r.id===cb.dataset.rid);
    if(r){r.enabled=cb.checked;saveState();renderTransactions();}
  }));
}
// The rules, in a modal rather than a dropdown wedged above the list. "Add"
// and "View" are separate doors now, so neither is hidden behind the other.
function openRecurringList(){
  const rows=state.recurringTemplates||[];
  document.getElementById('modalTitle').textContent=`\u26a1 ${t('recurring_title')}`;
  document.getElementById('modalBody').innerHTML=`
    <p class="recurring-desc">${t('recurring_desc')}</p>
    ${rows.length?`<div class="recurring-list">${recurringRowsHtml()}</div>`
      :`<p class="recurring-empty">${t('recurring_empty')}</p>`}
    <div class="edit-tx-actions">
      <button class="btn btn-primary" id="recListAddBtn" type="button">${t('recurring_add_rule')}</button>
      <button class="btn btn-ghost btn-sm" id="recListCloseBtn" type="button">${t('tx_way_close')}</button>
    </div>`;
  document.getElementById('tutorialOverlay').hidden=false;
  bindRecurringRows(document.getElementById('modalBody'));
  document.getElementById('recListAddBtn')?.addEventListener('click',()=>openRecurringModal(null));
  document.getElementById('recListCloseBtn')?.addEventListener('click',closeModal);
}
...
function renderTransactions() {
  ...
  const autoCount=(state.recurringTemplates||[]).length;
  ...
  el.innerHTML=`<div class="section-header"><h2 class="section-title">\uD83D\uDCCB ${t('tab_transactions')}</h2><div class="section-header-actions">${helpBtn('transactions')}<label class="btn btn-ghost btn-sm csv-label">${t('tx_import_csv')}<input type="file" id="csvInput" accept=".csv" style="display:none"></label></div></div>
    ...
    <div class="panel tx-ways"><div class="panel-inner-sm"><div class="tx-ways-row">
      ...
      <div class="tx-way tx-way--auto">
        <span class="tx-way-ico" aria-hidden="true">\u26A1</span>
        <span class="tx-way-txt"><span class="tx-way-title">${t('recurring_title')}</span><span class="tx-way-sub">${autoCount===0?t('tx_way_auto_none'):autoCount===1?t('tx_way_auto_one'):tf('tx_way_auto_many',autoCount)}</span></span>
        <span class="tx-way-btns">
          <button class="btn btn-ghost btn-sm" id="addRecurringBtn" type="button">${t('bud_add_btn')}</button>
          <button class="btn btn-ghost btn-sm" id="viewRecurringBtn" type="button"${autoCount?'':' disabled'}>${t('tx_way_view')}</button>
        </span>
      </div>
    </div></div></div>
  ...
  document.getElementById('viewRecurringBtn')?.addEventListener('click',openRecurringList);
}
  ...
  el.innerHTML=`<div class="section-header"><h2 class="section-title">💳 ${t('dpc_title')}</h2><div class="section-header-actions">${helpBtn('debt')}<button class="btn btn-ghost btn-sm" id="addDebtBtn">${t('dpc_add_btn')}</button></div></div>
    ...
    ${state.debts.length===0
      ...
      :`<div class="panel" style="margin-bottom:16px"><div class="module-table-wrap"><table class="module-table debt-table"><thead><tr>
        ...
        <tfoot><tr class="total-row"><td><strong>${t('dpc_totals')}</strong></td><td class="col-sm-hide"></td><td><strong>${fmt(totDebt)}</strong></td><td class="col-sm-hide"></td><td class="col-sm-hide"><strong>${fmt(totMin)}${t('dpc_mo_suffix')}</strong></td><td class="col-sm-hide"><strong>${fmt(totExtra)}${t('dpc_mo_suffix')}</strong></td><td colspan="2"></td></tr></tfoot>
      </table></div></div>`}
